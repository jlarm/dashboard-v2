...
class CreateOshaManual
{
    public function handle(Store $store, User $user, OshaManualFormData $formData): Osha
    {
        return DB::transaction(function () use ($store, $user, $formData): Osha {
            ...
            Storage::put(
                'osha-signatures/'.$signatureFileName,
