...
//        $this->store = Store::first();
        ...
        $this->module1 = $this->user->results->whereIn('course_id', $course1)->pluck('passed')->first();
        $this->module2 = $this->user->results->whereIn('course_id', $course2)->pluck('passed')->first();
        $this->module3 = $this->user->results->whereIn('course_id', $course3)->pluck('passed')->first();
