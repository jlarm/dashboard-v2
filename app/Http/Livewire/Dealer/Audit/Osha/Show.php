...
class Show extends Component
{
    ...
    public function mount()
    {
        ...
        $this->osha_q50_answer = $this->audit->osha_q50_answer;
        $this->osha_q50_comment = $this->audit->osha_q50_comment;
        $this->osha_q51_answer = $this->audit->osha_q51_answer;
        $this->osha_q51_comment = $this->audit->osha_q51_comment;
        $this->osha_q52_answer = $this->audit->osha_q52_answer;
        $this->osha_q52_comment = $this->audit->osha_q52_comment;
        $this->osha_q53_answer = $this->audit->osha_q53_answer;
        $this->osha_q53_comment = $this->audit->osha_q53_comment;
        $this->osha_q54_answer = $this->audit->osha_q54_answer;
        $this->osha_q54_comment = $this->audit->osha_q54_comment;
        $this->osha_q55_answer = $this->audit->osha_q55_answer;
        $this->osha_q55_comment = $this->audit->osha_q55_comment;
        $this->osha_q56_answer = $this->audit->osha_q56_answer;
        $this->osha_q56_comment = $this->audit->osha_q56_comment;
        $this->osha_q57_answer = $this->audit->osha_q57_answer;
        $this->osha_q57_comment = $this->audit->osha_q57_comment;
        $this->osha_q58_answer = $this->audit->osha_q58_answer;
        $this->osha_q58_comment = $this->audit->osha_q58_comment;
        $this->osha_q59_answer = $this->audit->osha_q59_answer;
        $this->osha_q59_comment = $this->audit->osha_q59_comment;
        $this->osha_q60_answer = $this->audit->osha_q60_answer;
        $this->osha_q60_comment = $this->audit->osha_q60_comment;
        $this->osha_q61_answer = $this->audit->osha_q61_answer;
        $this->osha_q61_comment = $this->audit->osha_q61_comment;
        $this->osha_q62_answer = $this->audit->osha_q62_answer;
        $this->osha_q62_comment = $this->audit->osha_q62_comment;
        $this->osha_q63_answer = $this->audit->osha_q63_answer;
        $this->osha_q63_comment = $this->audit->osha_q63_comment;
        $this->osha_q64_answer = $this->audit->osha_q64_answer;
        $this->osha_q64_comment = $this->audit->osha_q64_comment;
        $this->osha_q65_answer = $this->audit->osha_q65_answer;
        $this->osha_q65_comment = $this->audit->osha_q65_comment;
        $this->osha_q66_answer = $this->audit->osha_q66_answer;
        $this->osha_q66_comment = $this->audit->osha_q66_comment;
        $this->osha_q67_answer = $this->audit->osha_q67_answer;
        $this->osha_q67_comment = $this->audit->osha_q67_comment;
        $this->osha_q68_answer = $this->audit->osha_q68_answer;
        $this->osha_q68_comment = $this->audit->osha_q68_comment;
        $this->osha_q69_answer = $this->audit->osha_q69_answer;
        $this->osha_q69_comment = $this->audit->osha_q69_comment;
    }
