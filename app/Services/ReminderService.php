...
class ReminderService
{
    ...
    {
        throw_unless(method_exists($model, 'reminders'), RuntimeException::class, $model::class.' must have a reminders() relationship');

        throw_unless(property_exists($model, 'store_id') && $model->store_id !== null, RuntimeException::class, $model::class.' must have a store_id');
