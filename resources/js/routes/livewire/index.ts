...
* @route '/livewire-09f61674/upload-file'
*/
...
uploadFile.definition = {
    methods: ["post"],
    url: '/livewire-09f61674/upload-file',
...
* @route '/livewire-09f61674/preview-file/{filename}'
*/
...
previewFile.definition = {
    methods: ["get","head"],
    url: '/livewire-09f61674/preview-file/{filename}',
