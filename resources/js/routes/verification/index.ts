...
* @see app/Http/Controllers/Auth/EmailVerificationPromptController.php:19
...
* @see app/Http/Controllers/Auth/VerifyEmailController.php:19
* @route '//dashboard.test/verify-email/{id}/{hash}'
*/
...
verify.definition = {
    methods: ["get","head"],
    url: '//dashboard.test/verify-email/{id}/{hash}',
} satisfies RouteDefinition<["get","head"]>
...
* @see app/Http/Controllers/Auth/EmailVerificationNotificationController.php:18
* @route '//dashboard.test/email/verification-notification'
*/
...
send.definition = {
    methods: ["post"],
    url: '//dashboard.test/email/verification-notification',
