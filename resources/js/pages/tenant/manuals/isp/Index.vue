...
import { Download, FileSignature, Loader2, Trash2 } from 'lucide-vue-next';
...
const remove = (manual: Manual): void => {
    ...
    router.delete(isp.destroy.url({ manual: manual.id }), {
        preserveScroll: true,
        onFinish: () => {
        ...
        <div class="space-y-5">
            <header class="flex flex-wrap items-start justify-between gap-3">
                <Heading
                    ...
                    :description="
                        store
                            ? `Signed Information Security Program manuals for ${store.name}.`
                            : 'Signed Information Security Program manuals across your stores.'
                    "
                />
                    ...
                    <TableBody>
                                ...
                                <TableCell class="w-0 whitespace-nowrap pr-4 text-right">
                                    <div class="flex items-center justify-end gap-2">
                                        ...
                                        >
                                            ...
                                            <DialogContent>
                                                <DialogHeader>
                                                    <DialogTitle>Delete ISP Manual</DialogTitle>
                                                </DialogHeader>
                                                <p class="text-sm text-muted-foreground">
                                                    Delete the ISP manual signed on
                        ...
                        <TableRow v-else>
                            <TableCell colspan="4" class="py-12 text-center">
                                <FileSignature class="mx-auto size-10 text-muted-foreground" />
