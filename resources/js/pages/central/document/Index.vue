...
import CreateDocumentDialog from "@/pages/central/document/components/CreateDocumentDialog.vue";
import DeleteDocumentDialog from "@/pages/central/document/components/DeleteDocumentDialog.vue";
...
<template>
    <AppLayout :breadcrumbs="breadcrumbItems">
        <template #actions>
            <CreateDocumentDialog v-if="props.can.create" />
        </template>
        <div class="w-full max-w-3xl mx-auto">
            <Input v-model="search" placeholder="Search documents..." class="w-1/3 mb-5" />
            <Table>
                <TableBody>
                    <TableRow
