...
* @route '/livewire-09f61674/livewire.js'
*/
...
returnJavaScriptAsFile.definition = {
    methods: ["get","head"],
    url: '/livewire-09f61674/livewire.js',
...
* @route '/livewire-09f61674/livewire.min.js.map'
*/
...
maps.definition = {
    methods: ["get","head"],
    url: '/livewire-09f61674/livewire.min.js.map',
} satisfies RouteDefinition<["get","head"]>
...
* @route '/livewire-09f61674/livewire.csp.min.js.map'
*/
...
cspMaps.definition = {
    methods: ["get","head"],
    url: '/livewire-09f61674/livewire.csp.min.js.map',
} satisfies RouteDefinition<["get","head"]>
