...
* @route '//dashboard-v2.test/contracts/{contract}/pdf'
*/
...
generate.definition = {
    methods: ["post"],
    url: '//dashboard-v2.test/contracts/{contract}/pdf',
...
const ContractPdfController = { generate, download }

export default ContractPdfController