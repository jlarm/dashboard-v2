...
* @see app/Http/Controllers/Tenant/DashboardController.php:51
* @route '/dashboard'
*/
...
* @see app/Http/Controllers/Tenant/DashboardController.php:136
...
* @see app/Http/Controllers/Tenant/DashboardController.php:171
