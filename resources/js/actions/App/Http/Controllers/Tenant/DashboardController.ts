...
* @see app/Http/Controllers/Tenant/DashboardController.php:52
* @route '/dashboard'
*/
...
* @see app/Http/Controllers/Tenant/DashboardController.php:143
...
* @see app/Http/Controllers/Tenant/DashboardController.php:178
