...
* @route '/employees/deleted/{user}/restore'
*/
const restoreEmployeeForm = (args: { user: number | { id: number } } | [user: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: restoreEmployee.url(args, options),
    method: 'post',
})
...
* @route '/employees/deleted/{user}/restore'
*/
restoreEmployeeForm.post = (args: { user: number | { id: number } } | [user: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: restoreEmployee.url(args, options),
    method: 'post',
})

restoreEmployee.form = restoreEmployeeForm

/**
* @see \App\Http\Controllers\Tenant\UserController::index
* @see app/Http/Controllers/Tenant/UserController.php:63
* @route '/employees'
*/
...
* @see app/Http/Controllers/Tenant/UserController.php:89
...
* @see app/Http/Controllers/Tenant/UserController.php:113
* @route '/employees/invite'
*/
...
* @see app/Http/Controllers/Tenant/UserController.php:251
...
* @see app/Http/Controllers/Tenant/UserController.php:436
...
* @see app/Http/Controllers/Tenant/UserController.php:461
...
* @see app/Http/Controllers/Tenant/UserController.php:291
...
* @see app/Http/Controllers/Tenant/UserController.php:304
...
* @see app/Http/Controllers/Tenant/UserController.php:322
...
* @see app/Http/Controllers/Tenant/UserController.php:333
...
* @see app/Http/Controllers/Tenant/UserController.php:347
...
* @see app/Http/Controllers/Tenant/UserController.php:361
...
* @see app/Http/Controllers/Tenant/UserController.php:396
* @route '/employees/{user}'
*/
...
* @see app/Http/Controllers/Tenant/UserController.php:410
* @route '/employees/{user}'
*/
...
* @see app/Http/Controllers/Tenant/UserController.php:421
