                        ...
                        <x-table.cell colSpan="6">
                            <div class="p-5 min-h-100  flex flex-col justify-center items-center text-center mt-10">
                                <svg class="w-48 mx-auto" width="87" height="65" viewBox="0 0 87 65" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <rect y="35" width="6" height="30" fill="currentColor" class="fill-gray-200"/>
                                    <rect x="9" y="20" width="6" height="45" fill="currentColor" class="fill-gray-200"/>
                                    <rect x="18" y="25" width="6" height="40" fill="currentColor" class="fill-gray-200"/>
                                    <rect x="27" width="6" height="65" fill="currentColor" class="fill-gray-200"/>
                                    <rect x="36" y="5" width="6" height="60" fill="currentColor" class="fill-gray-200"/>
                                    <rect x="45" y="40" width="6" height="25" fill="currentColor" class="fill-gray-200"/>
                                    <rect x="54" y="25" width="6" height="40" fill="currentColor" class="fill-gray-200"/>
                                    <rect x="63" y="12" width="6" height="53" fill="currentColor" class="fill-gray-200"/>
                                    <rect x="72" width="6" height="65" fill="currentColor" class="fill-gray-200"/>
                                    <rect x="81" y="44" width="6" height="21" fill="currentColor" class="fill-gray-200"/>
                                </svg>
