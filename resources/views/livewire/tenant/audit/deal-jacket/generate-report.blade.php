<form wire:submit="generate" class="space-y-4">
    <h2 class="text-lg font-semibold">Generate Deal Jacket Report</h2>
    ...
    <div class="flex justify-end gap-2">
        <x-secondary-button type="button" wire:click="$dispatch('modal-close')" wire:loading.attr="disabled">
            Cancel
        </x-secondary-button>
