        ...
        <x-menu-dropdown align="right" width="48">
            ...
            <x-slot:content>
                <x-menu-dropdown-item
                    :href="route('dealer.audit.deal-jackets.single', ['dealJacketGroup' => $dealJacketGroup, 'dealJacket' => $dealJacket,])"
                >
                ...
                <x-menu-dropdown-item
                    :href="route('dealer.audit.deal-jackets.edit', ['dealJacketGroup' => $dealJacketGroup,'dealJacket' => $dealJacket,])"
                >
