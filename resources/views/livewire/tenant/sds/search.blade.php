            ...
            <div class="flex gap-2">
                <div class="flex-1">
                    <div class="relative">
                        ...
                        <input type="text" wire:model.defer="search" class="py-1 sm:py-1.5 ps-10 pe-8 block w-full bg-gray-100 border-transparent rounded-lg sm:text-sm focus:border-arm-blue-500 focus:ring-arm-blue-500 disabled:opacity-50 disabled:pointer-events-none" placeholder="Search projects">
