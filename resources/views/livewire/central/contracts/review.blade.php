    ...
    <div class="text-sm prose max-w-6xl mx-auto">
        ...
        <ul>
            @foreach($services as $service)
                <li>{{ $this->reviewLabel($service) }}</li>
            @endforeach
        </ul>
        ...
        <form wire:submit.prevent="submit">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-10 mt-12">
                ...
                <div>
                    ...
                    <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                        <div class="sm:col-span-6">
                            <x-input-label class="text-xs" for="dealerName" :value="__('Address *')" />
                        ...
                        <div class="sm:col-span-2">
                            <x-input-label class="text-xs" for="dealerPhysicalCity" :value="__('City *')" />
                        ...
                        <div class="sm:col-span-2">
                            <x-input-label class="text-xs" for="dealerPhysicalState" :value="__('State *')" />
                        ...
                        <div class="sm:col-span-2">
                            <x-input-label class="text-xs" for="dealerPhysicalZip" :value="__('Zip Code *')" />
                        ...
                        <div class="sm:col-span-6">
                            <x-input-label class="text-xs" for="dealerPhone" :value="__('Phone Number *')" />
                        ...
                        <div class="sm:col-span-3">
                            <x-input-label class="text-xs" for="dealerQiName" :value="__('Qualified Individual Name *')" />
                        ...
                        <div class="sm:col-span-3">
                            <x-input-label class="text-xs" for="dealerQiEmail" :value="__('Qualified Individual Email Address *')" />
                ...
                <div>
                    ...
                    <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                        <div class="sm:col-span-6">
                            <x-input-label class="text-xs" for="dealerBillingAddress" :value="__('Address *')" />
                        ...
                        <div class="sm:col-span-2">
                            <x-input-label class="text-xs" for="dealerBillingCity" :value="__('City *')" />
                        ...
                        <div class="sm:col-span-2">
                            <x-input-label class="text-xs" for="dealerBillingState" :value="__('State *')" />
                        ...
                        <div class="sm:col-span-2">
                            <x-input-label class="text-xs" for="dealerBillingZip" :value="__('Zip Code *')" />
                        ...
                        <div class="sm:col-span-6">
                            <x-input-label class="text-xs" for="dealerBillingFax" :value="__('Fax Number')" />
                        ...
                        <div class="sm:col-span-2">
                            <x-input-label class="text-xs" for="dealerBillingContactName" :value="__('Contact Name *')" />
                        ...
                        <div class="sm:col-span-2">
                            <x-input-label class="text-xs" for="dealerBillingContactTitle" :value="__('Contact Title *')" />
                        ...
                        <div class="sm:col-span-2">
                            <x-input-label class="text-xs" for="dealerBillingContactEmail" :value="__('Contact Email Address *')" />
            ...
            <div>
                <div class="mt-12 grid grid-cols-1 lg:grid-cols-2 gap-5">
                    <div class="space-y-8">
                        <div>
                            <x-input-label for="dealerPrintedName" :value="__('Name *')" />
                            <x-text-input wire:model.defer="dealerPrintedName" id="dealerPrintedName" class="block mt-1 w-full" type="text" name="dealerPrintedName" :value="old('dealerPrintedName')" />
                            @error('dealerPrintedName')
                            <div class="text-red-500 text-sm mt-2">
                                {{ __('The name field is required.') }}
                            </div>
                            @enderror
                        </div>
                        <x-signature-pad wire:model.defer="dealerSignature" />
                        @error('dealerSignature')
                        <div class="text-red-500 text-sm mt-2">
