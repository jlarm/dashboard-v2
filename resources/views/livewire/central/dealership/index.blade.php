                        ...
                        <div class="flex items-center justify-end gap-2">
                            ...
                            @can('delete-dealership')
                                <x-armp.button
                                    size="sm"
                                    variant="danger"
                                    x-on:click="if (confirm('Are you sure you want to delete {{ $dealership->name }}? The dealership database will be preserved and this can be reversed.')) { $wire.emit('deleteDealership', '{{ $dealership->id }}') }"
                                >
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.25" stroke-linecap="round" stroke-linejoin="round" class="size-4"><path d="M10 11v6"/><path d="M14 11v6"/><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6"/><path d="M3 6h18"/><path d="M8 6V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/></svg>
                                </x-armp.button>
                            @endcan
                        </div>
                    </x-table.cell>
