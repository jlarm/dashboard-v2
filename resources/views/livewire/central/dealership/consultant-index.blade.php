<table class="min-w-full divide-y divide-gray-300">
    ...
    <tr>
        ...
        <th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900">Multiple Locations</th>
    ...
    @forelse($dealerships as $dealership)
        <tr>
            ...
            <td class="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6 space-x-5">
                <button
                    wire:click="$emit('slide-over.open', 'central.dealership.consultant-edit', @js(['dealership' => $dealership->id]))">
                    Edit
                </button>
            </td>
        </tr>
    @empty
        <tr>
            <td class="py-4 pl-4 pr-3 text-center font-medium text-arm-blue-700 sm:pl-6" colspan="5">No Dealerships have
                been added.
            </td>
        </tr>
    @endforelse
