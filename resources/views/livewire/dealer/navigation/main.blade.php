<div>
    ...
    @can('create-users')
        ...
        >
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                 stroke-width="1.5"
                 class="{{ (request()->segment(1) === 'scans' || request()->segment(3) === 'scans') ? 'text-arm-blue-500' : 'text-gray-400 group-hover:text-gray-500' }} mr-3 flex-shrink-0 h-6 w-6"
                 stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round"
    ...
    @can('view-vendors')
        ...
        >
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                 stroke-width="1.5"
                 class="{{ (request()->segment(1) === 'vendors' || request()->segment(3) === 'vendors') ? 'text-arm-blue-500' : 'text-gray-400 group-hover:text-gray-500' }} mr-3 flex-shrink-0 h-6 w-6"
                 stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round"
    ...
    @can('create-users')
        ...
        @endif
            ...
            >
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" data-slot="icon" class="text-gray-400 hover:text-gray-900 hover:bg-gray-50 mr-3 w-6 h-6">
    ...
    <!--  LOGS -->
    @can('delete-stores')
        @if (request()->segment(1) === 'logs' || !tenant('locations'))
            <a
            ...
            >
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                     stroke-width="1.5"
                     stroke="currentColor"
                     class="{{ (request()->routeIs('dealer.logs.index') || request()->routeIs('dealer.logs.index')) ? 'text-arm-blue-500' : 'text-gray-400 group-hover:text-gray-500' }} mr-3 flex-shrink-0 h-6 w-6">
