<div>
    <div class="px-6 py-5 sm:flex sm:items-center sm:justify-between">
        <div class="min-w-0 flex-1">
            <h1 class="text-4xl font-bold text-arm-blue-900 sm:truncate leading-normal">Create Phishing Simulation</h1>
        </div>
                ...
                @else
                    <div class="max-w-3xl mx-auto">
                        <form wire:submit="create" class="space-y-3">
                            ...
                            <div>
                                <x-input-label for="name" :value="__('Schedule Date')" />
                                <x-text-input wire:model="date" x-ref="date" id="name" class="block mt-1 w-full" type="text" name="name" required autofocus autocomplete="name" />
                                <x-input-error :messages="$errors->get('name')" class="mt-2" />
                            </div>
                            <div>
                            ...
                            <div class="flex gap-3">
                                ...
                                <svg wire:loading class="animate-spin -ml-1 mr-3 h-5 w-5 text-purple-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
