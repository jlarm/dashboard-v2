<div>
    ...
    <div class="container mx-auto">
        <div class="border-b border-gray-200 bg-white px-4 py-5 sm:px-6">
            <div class="-ml-4 -mt-4 flex flex-wrap items-center justify-between sm:flex-nowrap"><div class="ml-4 mt-4 flex-shrink-0">
                    <x-application-logo class="h-6" />
                </div>
                <div class="ml-4 mt-4 text-right">
                    <h3 class="text-base font-semibold leading-6 text-gray-900">{{ $store->name }}</h3>
                    <p class="mt-1 text-sm text-gray-500">Manager and Compliance settings for your dealership's dashboard</p>
                </div>
            </div>
        </div>
    </div>
    <form wire:submit.prevent="update" class="container mx-auto">
    ...
    <div class="h-screen flex flex-col items-center justify-center">
        <x-application-logo class="h-14 mb-5" />
        <p>Thank you for providing your dealerships information, you can now close this tab.</p>
    </div>
    @endif
        <script>
