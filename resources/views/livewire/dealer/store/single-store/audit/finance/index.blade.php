    ...
    <div>
        <div class="py-5 sm:flex sm:items-center">
            <div class="sm:flex-auto">
                <h1 class="text-4xl font-bold text-arm-blue-900 sm:truncate leading-normal">GLBA Walkthrough Audits</h1>
            </div>
            @can('create-audits')
            <div class="mt-4 sm:ml-16 sm:mt-0 sm:flex-none">
                <a
                    ...
                    href="{{ route('dealer.stores.audits.finance.create', $store) }}"
                >
                    Create Audit
                </a>
            </div>
                ...
                <div class="inline-block min-w-full py-2 align-middle">
                    <table class="min-w-full divide-y divide-gray-300">
                        ...
                        @forelse($financeAudits as $financeAudit)
                            <livewire:dealer.store.single-store.audit.finance.index-item :store="$store"
                            ...
                            <tr>
                                <td colspan="7"
                                    ...
                                    <div class="text-center">
                                        ...
                                        <div class="mt-6">
                                            <a href="{{ route('dealer.stores.audits.finance.create', $store) }}" class="inline-flex items-center rounded-md bg-arm-blue-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-arm-blue-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-arm-blue-600">
