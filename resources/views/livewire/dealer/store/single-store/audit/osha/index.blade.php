                            ...
                            <tr>
                                <td colspan="7"
                                    ...
                                    <div class="text-center">
                                        ...
                                        <div class="mt-6">
                                            <a href="{{ route('dealer.stores.audits.osha.create', $store) }}" class="inline-flex items-center rounded-md bg-arm-blue-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-arm-blue-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-arm-blue-600">
