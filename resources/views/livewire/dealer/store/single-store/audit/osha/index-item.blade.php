<tr>
    ...
    <td class="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6 lg:pr-8 space-x-5">
        @if(!$audit->draft)
            <button type="button"
        ...
        @endif
        <a
            href="{{ route('dealer.stores.audits.osha.show', [$store, $audit]) }}"
