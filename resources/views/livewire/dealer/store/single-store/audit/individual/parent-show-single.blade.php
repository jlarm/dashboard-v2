<tr>
    ...
    <td class="whitespace-nowrap px-3 py-4 text-sm font-medium text-gray-900">{{ $individualAudit->customer_name }}</td>
    <td class="whitespace-nowrap px-3 py-4 text-sm font-medium text-gray-900">{{ $individualAudit->manager->name ?? '' }}</td>
