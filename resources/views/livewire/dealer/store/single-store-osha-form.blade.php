<div>
    ...
    <div class="mx-auto">
        <div class="relative md:flex">
            <div class="w-64 fixed inset-y-0 z-10 flex flex-col pr-6 mt-52 border-r">
                ...
                <ul class="toc mt-6 space-y-6 text-gray-500">
                    ...
                    <li class="text-sm">
                        <a href="#mesg" class="hover:text-arm-orange-600 transition">Machine Equipment
                            Safety/Guarding</a>
                    </li>
                </ul>
            </div>
            <div class="pl-72 relative top-10">
                <div class="space-y-10 prose max-w-none px-6">
                    <article id="gq">
                        <h1 class="text-arm-blue-600">General Questions</h1>
                        <form class="divide-y" wire:submit.prevent="submit">
                            <div class="pb-10 space-y-6">
                                <div class="grid grid-cols-2 gap-5">
                                    <div>
                                        <label for="qi" class="block text-sm font-medium text-gray-700">Qualified
                                            Individual
                                            Name</label>
                                        <div class="mt-1">
                            ...
                            <div class="py-10 space-y-6">
                                @if(!tenant('locations'))
                                    ...
                                    <div class="grid grid-cols-2 gap-5">
                                        <div>
                                            <label for="pepn" class="block text-sm font-medium text-gray-700">Police
                                                ...
                                                Phone Number</label>
                                            <div class="mt-1">
                                                <input disabled wire:model.defer="pepn" type="text" name="pepn"
                                                       id="pepn"
                                                       class="block w-full rounded-md border-gray-300 shadow-sm focus:border-arm-blue-500 focus:ring-arm-blue-500 sm:text-sm">
                                                @error('pepn')
                                                <p class="mt-2 text-sm text-red-600">This field is required.</p>
                                        ...
                                        <div>
                                            ...
                                            <div class="mt-1">
                                                <input disabled wire:model.defer="pnepn" type="text" name="pnepn"
                                                       id="pnepn"
                                                       class="block w-full rounded-md border-gray-300 shadow-sm focus:border-arm-blue-500 focus:ring-arm-blue-500 sm:text-sm">
                                                @error('pnepn')
                                                <p class="mt-2 text-sm text-red-600">This field is required.</p>
                                    ...
                                    <div class="grid grid-cols-2 gap-5">
                                        <div>
                                            <label for="fepn" class="block text-sm font-medium text-gray-700">Fire
                                                Emergency
                                                Phone Number</label>
                                            <div class="mt-1">
                                                <input disabled wire:model.defer="fepn" type="text" name="fepn"
                                                       id="fepn"
                                                       class="block w-full rounded-md border-gray-300 shadow-sm focus:border-arm-blue-500 focus:ring-arm-blue-500 sm:text-sm">
                                                @error('fepn')
                                                <p class="mt-2 text-sm text-red-600">This field is required.</p>
                                        ...
                                        <div>
                                            <label for="fnepn" class="block text-sm font-medium text-gray-700">Fire
                                                Non-Emergency Phone Number</label>
                                            <div class="mt-1">
                                                <input disabled wire:model.defer="fnepn" type="text" name="fnepn"
                                                       id="fnepn"
                                                       class="block w-full rounded-md border-gray-300 shadow-sm focus:border-arm-blue-500 focus:ring-arm-blue-500 sm:text-sm">
                                                @error('fnepn')
                                                <p class="mt-2 text-sm text-red-600">This field is required.</p>
                            ...
                            <div class="py-10 space-y-6">
                                <div>
                                    <label for="alarmSystem" class="block text-sm font-medium text-gray-700">What type
                                        of
                    ...
                    <article id="eap">
                        ...
                        <div>
                            <h2>Purpose</h2>
                            <p><strong>{{ config('app.name') }}</strong> is dedicated to the protection of its employees
                                from emergencies such as
                                tornadoes and fires. When emergencies do occur, our Emergency Action Plan (EAP) is
                                initiated.
                                This EAP is in place to ensure employee safety from emergencies during regular hours and
                                after hours. It provides a written document detailing and organizing the actions and
                                procedures
                            ...
                            <p>OSHA's Emergency Action Plan requirements, found at 29 CFR 1910.38(a), require
                                <strong>{{ config('app.name') }}</strong> to have a written emergency action plan (EAP).
                                This plan applies to all operations
                            ...
                            <p>The EAP communicates to employees, policies and procedures to follow in emergencies. This
                                written plan is available, upon request, to employees, their designated representatives,
                                and
                                any
                                OSHA officials who ask to see it.</p>
                            <h2>Administrative Duties</h2>
                            <p><strong>{{ $qi }}</strong> (or designee) is the (EAP) Emergency Action Plan
                                administrator,
                                who has
                                overall responsibility for the plan. This responsibility includes the following:</p>
                            <ul>
                                <li>Developing and maintaining a written Emergency Action Plan for regular and after
                                    hours
                                    work conditions;
                                </li>
                                ...
                                <li>Ensuring that equipment is placed and locked in storage rooms or desks for
                                    protection;
                                </li>
                                <li>Maintaining records and property as necessary; and</li>
                                <li>Ensuring that our facility meets all local fire codes, building codes, and
                                    regulations.
                                </li>
                            </ul>
                            <p><strong>{{ $qi }}</strong> is responsible for reviewing and updating the plan as
                                necessary.
                                Copies
                                of this plan may be obtained from <strong>{{ $qi }}’s</strong> office or compliance
                                dashboard.</p>
                            <p><strong>{{ $qi }}</strong>, has full authority to decide to implement the EAP if he/she
                                believes an
                            ...
                            <p>These telephone numbers of key management personnel have been distributed to the
                                following
                                persons to be retained in their homes for use in communicating an emergency occurring
                                during
                                non-work hours:</p>
                            <table>
                                <thead>
                            ...
                            <p>If, after reading this plan, you find that improvements can be made, please contact the
                                Plan
                                Administrator, <strong>{{ $qi }}</strong>. We encourage all suggestions because we are
                                committed
                            ...
                            <h2>Alarms</h2>
                            <p>Different emergencies call for different alarms to indicate what actions employees should
                                take.
                                <strong>{{ config('app.name') }}</strong> has established an employee alarm system that
                                complies with 29 CFR 1910.165.
                                <strong>{{ config('app.name') }}</strong> uses in house fire suppression... We use a
                                distinctive alarm capable of
                                identification as a signal whether or not to evacuate for each emergency. We realize
                                that
                                where
                                alarm signals have similar sounds and are used for purposes other than to signal
                                evacuation,
                                they can be confused with the fire alarm signal and either be ignored or cause
                                overreaction.
                                Therefore, we use a distinctive signal for each purpose, including alerting fire brigade
                                members,
                                if applicable. Fire alarms are located on each floor near each required exit. We will
                                use
                                the
                            ...
                            <p>We have posted the following emergency telephone numbers near telephones, or emergency
                                notice boards, and other conspicuous locations for use when telephones serve as a means
                                of
                            ...
                            <p>When employees detect an emergency that requires an evacuation, such as a fire or
                                hazardous
                                release, they should notify direct supervisor, manager in charge of their department,
                                call
                                911.
                                Employee, supervisor or manager must call 911 if building alarm has not been activated.
                                Building alarms may also activate and notify emergency response and local Fire
                                Department.</p>
                            <p>Our backup method for reporting emergencies that require evacuation includes the
                                following:</p>
                            ...
                            <p>Some emergencies require evacuation or escape procedures, while some require employees to
                                stay indoors, or in a safe area. Our emergency escape procedures are designed to respond
                                to
                                many potential emergencies, depending on the degree of seriousness. Nothing in these
                                procedures precludes the Plan Administrator&#39;s authority in determining whether
                                employees
                            ...
                            <p>Our emergency escape procedures and assignments are designed to respond to many potential
                                emergencies that require them, including: Fire, explosions and or hazardous chemical
                                releases
                                such as chemical spills...</p>
                            <p>Employees need to know what to do if they are alerted to a specific emergency. After an
                                alarm
                                is sounded to evacuate, employees should take the following steps:</p>
                            <p>Cease working and proceed to the nearest available and safe exit to leave the facility.
                                Cover
                                steps for evacuating non-employees and disabled employees.</p>
                            <p>Once evacuated, employees are to head toward their designated exterior or safe area,
                                where a
                                head count will be performed, and further instructions given. Following is a list of
                                exterior
                            ...
                            <p>Supervisors will assist in a safe and orderly evacuation for all types of emergencies
                                that
                                require
                                evacuation. Once evacuation is complete, they conduct head counts. The supervisors are
                                trained in the complete workplace layout and the various alternative escape routes from
                                the
                                workplace. Before leaving, these supervisors check rooms and other enclosed spaces in
                                the
                            ...
                            <p>The Supervisors will also serve as a resource of information about emergency procedures
                                and
                                conduct head counts once evacuation is complete.</p>
                            <p>Frontline supervisors must be aware of the locations of those employees working on a
                                particular
                                day when an emergency occurs, as well as suppliers, customers, and other non-employees
                                on
                                ...
                                fire/rescue departments in determining whether rescue efforts are necessary. Each
                                manager
                                will
                            ...
                            <ul>
                                ...
                                <li>Reports in to a central checkpoint managed by <strong>{{ $qi }}</strong> or
                                    designee,
                                    and
                                </li>
                                <li>Assumes role of department contact to answer questions.</li>
                            </ul>
                            <p>Head count results should be given to the Fire Chief, and firefighter, if requested.
                                Follow
                                any
                                and all Fire Departments and emergency response personnel recommendations.</p>
                            <p>No employees are to return to the buildings until advised by their supervisor or designee
                                (after
                                determination has been made that such re-entry is safe). If anyone is injured or
                                contaminated,
                                the Plan Administrator will activate rescue and first aid actions with the local
                                emergency
                                response teams, i.e., fire department, police and or EMS personnel. If an emergency
                                incident
                            ...
                            <h2>Non-Evacuation Emergency Procedures</h2>
                            <p><strong>{{ config('app.name') }}</strong> has the following non-evacuation procedures:
                            </p>
                            <p>Proceed to the nearest shelter, or move to a different area a safe distance from the
                                emergency.</p>
                            <p><i>Responding to a tornado alarm</i></p>
                            <p>In the event of a tornado, it is corporate policy to provide emergency warning and
                                shelter.
                                Once
                                employees are made aware of a tornado situation, they are to follow these
                                procedures:</p>
                            <p>Tornado emergency will include alerting any visitors to the emergency and taking those
                                visitors
                                with them to the nearest tornado shelter.</p>
                            <p>Employees should stay away from windows, but stay inside the building they are in.
                                Employees
                                are not to leave the shelter or return to their regular duties until the all clear is
                                given.</p>
                            <p><strong>{{ $qi }}</strong> or designee will determine when it is safe for employees to
                                leave
                                their
                                tornado shelter and return to work. At that time, the Plan Administrator will notify the
                                emergency
                            ...
                            <p>If anyone is injured or contaminated, the Plan Administrator will activate rescue and
                                first
                                aid
                                actions coordinating with local emergency response teams.</p>
                            <h2>Plan Administrator Duties</h2>
                            <p>During an emergency, <strong>{{ $qi }}</strong> will do the following:</p>
                            <p>Assist where ever possible.</p>
                            <h3>Rescue and First Aid</h3>
                            <p>Rescue and first aid may be necessary during emergency situations. Circumstances calling
                                for
                            ...
                            <h3>Training</h3>
                            <p>Our Plan Administrator reviews with each of our employees at the following times, those
                                parts
                                of
                                the Emergency Action Plan that employees must know to protect themselves in the event of
                                an
                                emergency:</p>
                            <ul>
                                <li>Initially when the plan is developed,</li>
                                <li>Whenever a new employee is hired,</li>
                                <li>Whenever an employee&#39;s responsibilities or designated actions under the plan
                                    change,
                                </li>
                                <li>Whenever new equipment, materials, or processes are introduced into the workplace,
                                </li>
                                <li>Whenever the layout or design or the facility changes, and</li>
                                <li>Whenever the plan is changed.</li>
                            </ul>
                            <p>The training includes the following: self-administered from the supervisors to the
                                employees.</p>
                            <p>The information in this plan is not intended for casual reading, but is intended to get
                                the
                            ...
                            <p>Fire extinguishers, fire hoses, brooms, shovels, hoses, spill control kits, absorbent,
                                and
                                flashlights.</p>
                        </div>
                    </article>
                    <article id="hcp">
                        <h1 class="text-arm-blue-600">Hazard Communication Program</h1>
                        <h2>Purpose</h2>
                        <p>The purpose of this program is to inform interested persons, including employees, that
                            <strong>{{ config('app.name') }}</strong> is complying with the OSHA Hazard Communication
                            Standard, Title 29 Code of
                        ...
                        <p>This program applies to all work operations in our company where employees may be exposed
                            ...
                            situation.</p>
                        <p>The safety and health manager, <strong>{{ $qi }}</strong>, is the program coordinator, acting
                            as
                            the
                            representative of the plant manager, who has overall responsibility for the program.
                            <strong>{{ $qi }}</strong> will review and update the program, as necessary. Copies of the
                            written program
                            may be obtained from <strong>{{ $qi }}</strong>, service department or online compliance
                            dashboard.</p>
                        <p>All employees, or their designated representatives, can obtain further information on this
                            written
                        ...
                        <h2>Hazard Evaluation Procedures</h2>
                        <p>Our chemical inventory is a list of hazardous chemicals known to be present in our workplace.
                            ...
                            those chemicals are and how to protect themselves. All SDS that enter into the building
                            through
                            shipping and receiving will be taken to the supervisor’s office were the SDS booklets are
                            kept.</p>
                        <p>The safety and health manager, <strong>{{ $qi }}</strong>, also keeps the chemical inventory
                            list,
                            along with related work practices used in our facility located in the service department’s
                            supervisor&#39;s office or electronically on any dealership’s computers, where it is always
                            accessible
                            during work hours.</p>
                        <p>The company does not manufacture any chemicals and, therefore, does not make any hazard
                            determinations.</p>
                        <p>After the chemical inventory is compiled, it serves as a list of every chemical for which an
                            SDS
                            must be maintained. Parts <strong>Managerx</strong> updates the inventory as necessary.</p>
                        <h2>Material Safety Data Sheets (SDS’s)</h2>
                        <p><strong>{{ $pm }}</strong>, <strong>titlex3</strong> will be responsible for
                            obtaining/maintaining the SDSs at our facility.
                            He/she will contact the chemical manufacturer or vendor if additional research is necessary.
                            All
                            new procurements for the company must be cleared by <strong>{{ $pm }}</strong> or
                            <strong>{{ $sm }}</strong>,</p>
                        <p>The material safety data sheets are kept at the following location(s) in our facility:
                            service
                            department’s supervisor&#39;s office, <strong>{{ $sm }}</strong>. Employees can obtain
                            access to
                            them by
                            accessing the supervisor’s office during their shift and on a SDS link provided on
                            dealership
                            computers.</p>
                        <p>The procedure followed if the SDS is not received at time of first shipment is: contact
                            chemical
                        ...
                        <h2>Labels &amp; Other Forms of Warning</h2>
                        ...
                        <p><strong>{{ $sm }}</strong>, is responsible for ensuring that all hazardous chemicals in
                            in-plant
                        ...
                        <p><strong>{{ $pm }}</strong>, is responsible for ensuring the proper labeling of any shipped
                            containers.</p>
                        <p><strong>{{ $pm }}</strong> or designee will refer to the corresponding SDS to assist
                            employees in
                        ...
                        <p>If employees transfer chemicals from a labeled container to a portable container that is
                            intended
                        ...
                        <p>The following procedures are used to review and update label information when necessary and
                            to ensure that labels that fall off or become unreadable are immediately replaced: during
                            the
                            quarterly audit supervisors will note any damaged or missing labels and replace
                            immediately.</p>
                        <h2>Training</h2>
                        ...
                        <p>We ask our employees to ask Automotive Risk Management Partners and
                            <strong>{{ $sm }}</strong> if
                        ...
                        <p>Training content is organized according to an on-line web base training program that is time
                            and
                        ...
                        <p>The procedure to train new employees at the time of their initial assignment is when they are
                            ...
                            chemical.</p>
                        <p>Annually employees will be administered the on-line web base training modules and sign off
                            on.</p>
                        <h2>Hazards of Unlabeled Pipes</h2>
                        ...
                        <p class="text-red-500 font-bold">"STATE PLAN STATE SPECIFIC Hazard communication added here if
                            needed"</p>
                    </article>
                    <article id="hazwoper">
                        <h1 class="text-arm-blue-600">HAZWOPER (Hazardous Waste Operations and Emergency Response)</h1>
                        <h2>Administrative Duties</h2>
                        <p><strong>{{ $sm }}</strong>, is responsible for developing and maintaining our facility&#39;s
                            HAZWOPER
                            plan. The plan is available for review and is kept at supervisor&#39;s and or manager&#39;s
                            office in the
                        ...
                        <p>Because employees use a variety of types of PPE and/or respiratory equipment, in their
                            day-to-
                        ...
                        <p>The decontamination procedures used at our facility are Universal absorbent mats, socks,
                            ...
                            coolants, solvents, water and many other types of liquids found in and around auto
                            dealerships.
                            Call emergency response i.e., fire departments HAZMAT unit if spill is in a large
                            quantity.</p>
                        ...
                        <h2>HAZWOPER Training Program</h2>
                        ...
                        <p>Workers also must know the names of personnel and their alternatives responsible for site
                            ...
                            they have been trained to the level required by their job function and responsibility and
                            has
                            been
                            ...
                            annually. Employee training requirements are further defined by the nature of the work
                            (e.g.,
                            temporary emergency response personnel, firefighters, safety officers, HAZMAT personnel,
                            incident commanders, etc.)</p>
                        <p>At our facility, <strong>{{ $qi }}</strong>, is the person responsible for conducting
                            training.
                            We make
                        ...
                        <p>We want to offer the best training for our workers, so the format of the program that is used
                            is
                            to
                            utilize an outside consulting company that provides on line instructional
                        ...
                        <p>The procedure to train new employees at the time of their initial assignment is that they are
                            assign a series of training module through there department supervisor and will be
                            responsible
                            for completion in a short period of time, i.e., probationary period. Tracking the training
                            and
                        ...
                        <p>All emergency responders have received refresher training sufficient to maintain or
                            demonstrate
                            competency annually.</p>
                        <p>We ascertain that this plan is being followed by utilizing a web base training program that
                            time
                            and date stamps all training upon completion.</p>
                        <h2>Organizational Structure</h2>
                        <p><strong>{{ $sm }}</strong>, is the general supervisor who has the responsibility and
                            authority to
                            direct
                            all hazardous waste operations.</p>
                        <p><strong>{{ $qi }}</strong>, is the site safety and health supervisor who has the
                            responsibility
                            and
                        ...
                        <p>The lines of authority, responsibility, and communication are as follows:
                            <strong>{{ $qi }}</strong>,
                            <strong>{{ $sm }}</strong> and then <strong>{{ $pm }}</strong></p>
                        <p>Our organizational structure is reviewed and updated as necessary to reflect the current
                            status
                            of waste site operations.</p>
                        <h2>Site-Specific Safety and Health Plan</h2>
                        <p>Our Site-Specific Safety and Health Plan is a program that aids in eliminating or effectively
                            ...
                            identify the hazards of each phase of the specific site operation and is kept on the work
                            site.
                            The Site-Specific Safety and Health Plan addresses the safety and health hazards of each
                            phase of site operation and includes the requirements and procedures for employee
                            protection.</p>
                        ...
                        <p>The environmental sampling techniques and instrumentation that are used, including methods
                            of maintenance and calibration of monitoring and sampling equipment used, are as follows:
                            this
                        ...
                        <h2>Contractor Safety</h2>
                        <p>Contractors working at our facility need to be protected from hazards that may be on our
                            premises.</p>
                        <p>We routinely make the written safety and health program available to any contractor who will
                            be
                            involved with the hazardous waste operation.</p>
                    </article>
                    <article id="lt">
                        <h1 class="text-arm-blue-600">Lockout/Tagout – Energy Control Program</h1>
                        <h2>Purpose</h2>
                        <p>This procedure establishes this company&#39;s requirements for the lockout of energy
                            isolating
                            ...
                            <strong>{{ config('app.name') }}</strong> where employees must deal with lockout/tagout
                            ...
                            maintenance.</p>
                        <h2>Authorized and Affected Employees</h2>
                        <p>Authorized employees subject to the requirements of this program and to be trained on their
                            ...
                            supervisory personnel only, no hourly employees from
                            <strong>{{ config('app.name') }}</strong>
                            are authorized to utilize
                            lockout/tagout equipment. Affected employees subject to the requirements of this program and
                            to
                            be trained on their duties
                        ...
                        <p>The machinery and equipment in this facility that falls under the Control of Hazardous Energy
                            Standard includes the following: no such machine or equipment has the potential for stored
                            or
                        ...
                        <p>Affected employees are notified in person when their machine is to be locked out and or
                            tagged
                            out.</p>
                        ...
                        <p>Machine or equipment shutdown. The machine or equipment shall be turned off or shut down
                            ...
                            be utilized to avoid any additional or increased hazard(s) to employees as a result of
                            equipment
                            stoppage.</p>
                        ...
                        <p>- Lockout devices, where used, shall be affixed in a manner that will hold the energy
                            isolating
                            devices in a &quot;safe&quot; or &quot;off&quot; position.</p>
                        <p>- Tagout devices, where used, shall be affixed in such a manner as will clearly indicate that
                            the
                            operation or movement of energy isolating devices from the &quot;safe&quot; or &quot;off&quot;
                            position is prohibited.</p>
                        <p>Where tagout devices are used with energy isolating devices designed with the capability of
                            ...
                            have been attached. Where a tag cannot be affixed directly to the energy isolating device,
                            the
                        ...
                        <p>Stored energy. Following the application of lockout or tagout devices to energy isolating
                            devices,
                            all potentially hazardous stored or residual energy shall be relieved, disconnected,
                            restrained,
                            and otherwise rendered safe.</p>
                        <p>(ii) If there is a possibility of reaccumulating of stored energy to a hazardous level,
                            verification of
                        ...
                        <p>Verification of isolation. Prior to starting work on machines or equipment that have been
                            locked
                            out or tagged out, the authorized personnel shall verify that isolation and DE-energization
                            of
                            the
                        ...
                        <p>Lockout or tagout devices removal. Each lockout or tagout device shall be removed from each
                            ...
                            person who applied the lockout or tagout device is not available to remove it, that device
                            may
                            be
                            removed under the direction of the employer, provided that specific procedures and training
                            for
                        ...
                        <p>- Verification by the employer that the authorized person who applied the device is not at
                            the
                            facility;</p>
                        ...
                        <p>The machinery and equipment listed above follows this procedure to test the machines to
                            ...
                            control measures: Ensure that the equipment is disconnected from the energy source(s)
                            by:</p>
                        <p>Checking that no personnel are exposed, then
                            Verifying the isolation of the equipment by operating the push button or other normal
                            operating
                            or startup control(s) to make certain the equipment will not operate.
                            Return the operating control(s) to neutral or &quot;off&quot; position after verifying that
                            the
                            equipment is
                            isolated. The machine or equipment is now locked out and servicing or maintenance may safely
                            begin.</p>
                        <h2>Periodic Inspection</h2>
                        <p>A periodic inspection is done, looking at the energy control procedures performed to ensure
                            that
                            the procedure and requirements of the standard are being followed. This inspection is
                            performed bi-annually.</p>
                        <h2>Administrative Duties</h2>
                        <p><strong>{{ $sm }}</strong>, has overall responsibility for coordinating safety and health
                            programs in this
                            company.</p>
                    ...
                    <article id="esp">
                        <h1 class="text-arm-blue-600">Electrical Safety Plan</h1>
                        <h2>General Company Policy</h2>
                        <p>The purpose of this program is to inform interested persons, including employees, that
                            <strong>{{ config('app.name') }}</strong> is complying with the OSHA Electrical Safety
                            Standard,
                            Title 29 Code of Federal
                            Regulations 1910.333, by determining that this workplace needs written procedures for
                            preventing electric shock or other injuries resulting from direct/indirect electrical
                            contacts
                            to
                            employees working on or near energized or deenergized parts. This program applies to all
                            work
                            operations at <strong>{{ config('app.name') }}</strong> where employees may be exposed to
                            live
                            parts and/or those parts
                            that have been deenergized.</p>
                        <p><strong>{{ $qi }}</strong> has overall responsibility for coordinating safety and health
                            programs
                            in
                            this company. <strong>{{ $sm }}</strong> is the person having overall responsibility for the
                            Electrical
                            ...
                            employees receive instructions in the purpose and use of energy control procedures, as well
                            as
                            the other required elements of the Control of Hazardous Energy standard. This instruction
                            includes the deenergizing of equipment, applying locks and tags, verifying DE-energization,
                            and
                        ...
                        <p>If, after reading this program, you find that improvements can be made, please contact your
                            ...
                            safe workplace for all our employees and a successful electrical safety program is an
                            important
                            component of our overall safety plan. We strive for clear understanding, safe work
                            practices,
                            and involvement in the program from every level of the company.</p>
                        <h2>Hazard Analysis Report</h2>
                        <p>To determine areas of <strong>{{ config('app.name') }}</strong> that need to be included in
                            the
                            Electrical Safety Program,
                            the service manager has conducted a hazard analysis of our workplace. This analysis located
                            in
                            shop foreman’s office, has provided us with information identifying which departments have
                            equipment using electricity, various types of wiring installations, and the types of
                            employee
                            functions that must be covered by the Electrical Safety Program. The departments/areas of
                            our
                            company identified as having electrically operated equipment and/or wiring installations are
                            service department, technicians’ service bays, parts department, detail center, body shop
                            (if
                            applicable).</p>
                        <p>Electrically operated equipment that must be deenergized before work can be done on it and
                            ...
                            tools/equipment that once unplugged would need to power down i.e., hold a short-term
                            electrical
                            charge.</p>
                        <p>Employees of our company who are qualified to work on, near, or with energized electric
                            circuits
                            and equipment are employees who have undergone on-the-job training and who, in the course
                            of such training, has demonstrated an ability to perform duties safely at his or her level
                            of
                            training and who is under the direct supervision of a qualified person that is a qualified
                            person
                            for the performance of those duties.</p>
                        <p>Employees working on, near, or with energized electric circuits and equipment who have
                            limited
                        ...
                        <p>Every employee at <strong>{{ config('app.name') }}</strong> who faces the risk of electric
                            shock
                            from working on or near
                            energized or deenergized electrical sources receives training in electrical related safety
                            work
                            practices pertaining to the individual&#39;s job assignment.</p>
                        <p>The goal of our electrical safety training program is to ensure that all employees understand
                            the
                            hazards associated with electric energy and that they are capable of performing the
                            necessary
                        ...
                        <p>These are the electrical safety procedures we teach to those employees who have limited
                            knowledge (&quot;unqualified&quot;) of electrical circuitry but must work near or on such
                            electrical
                            equipment. This training must be completed before participants will be allowed to work in
                            areas
                        ...
                        <p>The procedures we follow when training new employees who will be working on or near
                            ...
                            electrical elements occur in our company, we provide additional employee training ensuring
                            the
                            safety of all affected workers. In this case, we follow these procedures: immediate
                            on-the-job
                            training will take place when situations such as new equipment, reorganization and
                            remodeling
                            take place in the dealership.</p>
                        <p><strong>{{ config('app.name') }}</strong> conducts the electrical safety training for all
                            employees. Every employee who
                            participates in the Electrical Safety Program receives an acknowledgement from the web base
                            training program which they will sign off on verifying that they have completed the course,
                            that
                            they understand the information presented, and that they will follow all company policies
                            and
                            procedures regarding electrical safety. These signed certificates of training as well as all
                            training
                            materials and documentation are kept on dealership’s online compliance dashboard.</p>
                        <h2>Lockout and Tagging Program</h2>
                        <p>It is a <strong>{{ config('app.name') }}</strong> policy that circuits and equipment must be
                        ...
                        <ul>
                            <li><strong>Application of locks and tags.</strong> Only authorized employees are allowed to
                                place a lock and
                                tag on each disconnecting means used to deenergize our circuits or equipment before work
                                begins. Our locks prevent unauthorized persons from reenergizing the equipment or
                                circuits
                                and
                                the tags prohibit unauthorized operation of the disconnecting device.
                            </li>
                            <li><strong>Verification of deenergized condition of circuits and equipment.</strong> Prior
                                to
                                work on the
                                equipment, we require that a &quot;qualified&quot; employee verify that the equipment is
                                deenergized and
                                cannot be restarted.
                            </li>
                            <li><strong>Reenergizing circuits and equipment.</strong> Before circuits or equipment are
                                reenergized, we
                                follow these steps in this order:
                                <ul>
                                    <li>A &quot;qualified&quot; employee conducts tests and verifies that all tools and
                                        devices have been
                                        removed.
                                    </li>
                                    ...
                                    <li>We do a visual inspection of the area to be sure all employees are clear of the
                                        circuits
                                        and equipment.
                                    </li>
                                </ul>
                        ...
                        <p>In addition to lockout and tagging elements, see &quot;LOTO&quot; safety tab for additional
                            full
                            disclosure
                            procedures.</p>
                        <p>Lockout/tagout must be performed by a qualified person as assigned by department supervisor.
                            They must be trained and authorized to deenergize, verify, and reenergize electric circuits
                            and
                            equipment in our company.</p>
                        <h2>Enforcement</h2>
                        <p>Constant awareness of and respect for electrical hazards, and compliance with all safety
                            rules
                            are considered conditions of employment. Supervisors and individuals in the Safety and
                            Personnel Department reserve the right to issue disciplinary warnings to employees, up to
                            and
                            including termination, for failure to follow the guidelines of this program.</p>
                        <h2>Appendix</h2>
                        <p>We have attached to this plan any lists, samples, or procedures we thought would ensure
                            better
                            understanding of our written program.</p>
                        <h2>DISCONNECTING HIGH VOLTAGE IN ELECTRIC/HYBRID VEHICLES</h2>
                        ...
                        <ul>
                            ...
                            <li>Battery Smart Module (BSM) which communicates on serial data to identifies a number of
                                situations where high voltage should be disabled or any other number of issues
                                identified
                                i.e., shorts, SIR, interlocks.
                                <ul>
                                    ...
                                    <li>Orange service plug (Disconnect switch) – for additional protection (interrupts
                                        the
                                        voltage coming out of battery packs).
                                    </li>
                                </ul>
                            </li>
                            <li>Once the vehicles Key is turned off, the BSM Opens the contacts inside the battery
                                disconnecting the High Voltage source from the actual outlet terminals that provide
                                power to
                                the vehicle.
                            </li>
                        </ul>
                        <h2>7 Step Process to insure proper HV source disconnected</h2>
                        <ol>
                            <li>Turn key off and remove it from the vehicle and store it on the workbench.</li>
                            <li>Disconnect cable from 12-volt battery on the negative lead and insure cable cannot
                                re-touch
                                battery terminal.
                            </li>
                            <li><span class="text-red-500">(Put High Voltage Gloves on)</span>
                                <ul>
                                    <li>Disconnect the orange service plug on the side of the HV battery and remove and
                                        store it on the workbench as well. This gives an additional level of protection
                                        in
                                        case the contact relays were stuck “Closed” after turning the key off or
                            ...
                            <li>Wait 10 minutes to ensure capacitors are fully discharged
                                <ul>
                                    <li>Take your volt meter and put leads on the positive and negative battery
                                        terminals
                                        and make sure the meter shows active 12 volts. This confirms your settings are
                                        correct on the meter.
                                    </li>
                                </ul>
                            </li>
                            <li><span class="text-red-500">(HV Gloves on)</span>
                                <ul>
                                    <li>Remove the Power Inverter electrical cover to give you access to the HV
                                        terminals
                                        inside.
                                    </li>
                                </ul>
                            ...
                            <li><span class="text-red-500">(HV Gloves on)</span>
                                <ul>
                                    <li>Take the voltmeter and touch each HV terminal and check that it is registering
                                        “0”
                                        volts.
                                    </li>
                                </ul>
                            ...
                            <li><span class="text-red-500">(HV Gloves on)</span>
                                <ul>
                                    <li>Reverse the polarity and check HV terminals again ensuring a reading of “0”
                                        volts.
                                    </li>
                            ...
                            <li>Re-check volt meter on the battery terminals again to ensure the meter is still
                                operating
                                properly and that all electrical tests were being recorded accurately at ZERO voltage.
                                Doing
                                this last check is called the “Live Dead Live” procedure.
                            </li>
                        </ol>
                        <h3>Live Dead Live Procedure Completed</h3>
                        <p><i>***Now you will know positively that the Hybrid/EV vehicle is not carrying any voltage
                                that
                                can harm you in any way. It is now safe to work on your vehicle.
                            </i></p>
                    </article>
                    <article id="swpp">
                        <h1 class="text-arm-blue-600">StormWater Pollution Plan</h1>
                        <h2>General Company Policy</h2>
                        <p>The purpose of this program is to inform interested persons, including employees, that our
                            company is complying with EPA requirements for preparing and maintaining a Stormwater
                            Written
                            Pollution Prevention Plan under the stormwater regulations (40 CFR 122).</p>
                        <h2>Administrative Duties</h2>
                        <p><strong>{{ $sm }}</strong>, is responsible for our written stormwater pollution prevention
                            plan.
                            Copies of our written plan may be obtained from service departments office. Employees can
                            obtain
                            access to the plan by accessing the supervisor’s office area to review.
                            <strong>{{ $sm }}</strong> and <strong>{{ $qi }}</strong>, make up our company's stormwater
                            pollution prevention committee.</p>
                        <h2>Evaluation of Pollution Sources</h2>
                        <p>We maintain a current drainage site map and topographic map of our facility.</p>
                        <p>We have had no significant spills and leaks of toxic or hazardous materials at our
                            facility.</p>
                        <p><strong>{{ config('app.name') }}</strong> has no significant materials that have been
                            treated,
                            stored or disposed in a manner to allow exposure to stormwater.</p>
                        <p>At our facility, the following activities have a high potential for contaminating stormwater:
                            working with the removal and storage of gasoline, oils, antifreeze etc. the following
                            pollutants
                            of concern may be associated with these activities: oil and gasoline discharge in excess
                            amounts</p>
                        <p>The following is the method we use for the on-site storage or disposal of these materials:
                            55-gallon drums and larger quantities kept outside above storage drums.</p>
                        <p>We use the following materials management practices to minimize contact of these materials
                            with
                            precipitation and stormwater runoff: utilizing built in traps and have them cleaned out and
                            removed by authorized Haz-Mat companies</p>
                        <p>Our facility has the following materials loading and access areas: parts department loading
                            dock
                            area</p>
                        <p>To help reduce pollutants in stormwater runoff, we use the following existing structural and
                            non-structural control measures: utilizing built in traps and have them cleaned out and
                            removed
                            by authorized Haz-Mat companies and to include regularly scheduled actions such as sweeping
                            or
                            inspections. </p>
                        <p>These measures are located throughout the dealership.</p>
                        <p>Our facility's stormwater does receive treatment. The following process is used: local city
                            and
                            or county water treatment centers</p>
                        <p>The following are predictions of the direction of flow for the types of pollutants likely to
                            be
                            present for each area of the plant generating stormwater discharges associated with
                            industrial
                            activity: N/A </p>
                        <p>The following types of pollutants are likely to be present for each area of the plant
                            generating
                            stormwater discharges associated with industrial activity: oils, gasoline and
                            antifreeze. </p>
                        <p>The following is a summary of our existing stormwater sampling data: there are no sampling
                            measures at this time.</p>
                        <h2>Primary Stormwater Practices and Elements</h2>
                        <p>We use standard and accepted practices, including management, maintenance, training, and
                            inspections, to reduce pollutants.</p>
                        <h2>Maintaining the Plan</h2>
                        <p><strong>{{ $sm }}</strong> is responsible for conducting periodic site evaluations.</p>
                        <p><strong>{{ $sm }}</strong> is responsible for keeping records of all inspections and reports.
                        </p>
                        <p><strong>{{ $sm }}</strong> is responsible for updating the plan as needed.</p>
                        <p>The following are the procedures for updating our plan: review annually with department
                            supervisor </p>
                        <h2>Special Requirements</h2>
                        <p><strong>{{ $qi }}</strong> and or <strong>{{ $sm }}</strong> is responsible for incorporating
                            into the plan any necessary changes resulting from major changes in a facility's design,
                            construction, operation or maintenance.</p>
                        <p><strong>{{ $sm }}</strong> is responsible for determining if the facility is subject to any
                            special requirements.</p>
                        <p><strong>{{ $sm }}</strong> is responsible for incorporating into the plan any applicable
                            special
                            requirements.</p>
                        <h2>Appendix</h2>
                        <p>We have attached lists, samples, or procedures to this plan that will help ensure better
                            understanding of our written program.</p>
                    </article>
                    <article id="uomp">
                        <h1 class="text-arm-blue-600">Used Oil Management Plan</h1>
                        ...
                        <p>Used oil, even when not classified as a hazardous waste under RCRA, can have harmful effects
                            if
                            it is released into the environment. In addition, people's health can be affected if used
                            oil is
                            handled improperly.</p>
                        <p>Superfund regulations allow the federal government to hold any party that created or
                            contributed
                            to the creation of a hazardous waste site (including some used oil) financially responsible
                            for
                            cleanup costs.</p>
                        <p>Used oil is a valuable resource because it has lubrication value and heat value. When treated
                            to
                            remove contaminants, the used oil can be used as a base stock to produce new lubricating
                            oil.
                            Because used oil has heat value, it can be burned as fuel. Properly burning the used oil
                            keeps
                            its heat value from being wasted and saves the virgin heating oil that would be burned
                            instead.</p>
                        <h2>Purpose</h2>
                        <p>This plan provides one source of written documentation for used oil records for
                            <strong>{{ config('app.name') }}</strong>. In addition, this plan will inform interested
                            persons, including company and contractor employees, about this company's compliance with
                            Environmental Protection Agency (EPA) requirements (found at 40 CFR 279) for used oil
                            generators.</p>
                        <p>This plan provides a written description of used oil management procedures, disposal methods,
                            and
                            transportation requirements. We encourage any suggestions that our employees have for
                            improving
                            our written plan for used oil management, as we are committed to developing and maintaining
                            an
                            effective protocol. We strive for clear understanding, environmentally sound practices, and
                            involvement in the plan from every level of the company.</p>
                        <h2>Administrative Duties</h2>
                        <p>Service manager is responsible for developing the written used oil management plan; for
                            ensuring
                            that our written plan is complete, kept up to date, and made available to applicable or
                            required
                            authorities; and for maintaining used oil management records. A copy of our used oil
                            management
                            plan may be reviewed by employees. It is located in the service manager’s office.</p>
                        <h2>Used Oil Defined</h2>
                        <p>The EPA defines used oil as "any oil that has been refined from crude oil or any synthetic
                            oil
                            that has been used and as a result of such use is contaminated by physical or chemical
                            impurities." Used oil can be generated during "do-it-yourself" projects, from automotive
                            sources, or during industrial operations. This includes oils that are used as hydraulic
                            fluid as
                            well as oils that are used to lubricate automobiles and other machinery, cool engines, or
                            suspend materials in industrial processes. Oils used for these purposes can become
                            contaminated
                            with physical materials (such as metal particles from engine wear) or chemical contaminants
                            (such as gasoline combustion products, like toluene).</p>
                        <h2>Used Oil Management</h2>
                        <p>At this facility, we generate used oil from removal of oil from automobiles for oil change
                            operations. It is likely to contain the following contaminants: metals and other engine
                            related
                            material</p>
                        ...
                        <ul>
                            ...
                            <li>Make sure our collection and storage set-ups are leak proof, spill proof, and that tanks
                                have lids or are covered to prevent water from entering.
                            </li>
                            <li>Use lockable fills to prevent dumping of materials into the tank when it is not
                                supervised.
                            </li>
                            <li>Maintain our collection containers regularly, comply with local fire and safety
                                regulations,
                                and avoid leaks and spills.
                            </li>
                            <li> Label storage tanks "Used Oil."</li>
                            <li>Clean up any used oil spills or leaks. This includes providing soak-up material (e.g.,
                                sawdust, kitty litter, or a commercial product) for minor spills. It keeps the area
                                clean
                                and helps prevent personal injury.
                            </li>
                            <li>Keep records of used oil sent to burners.</li>
                        </ul>
                        <p><i>Storing Used Oil</i></p>
                        <ul>
                            <li>Our facility stores used oil in 55-gallon drums and above storage tanks. This facility
                                follows these storage practices. We:
                            </li>
                            <li>Never mix used oil with any other material. This facility keeps gasoline, solvents,
                                degreasers, paints, and so on, from making the used oil a hazardous waste and increasing
                                collection costs.
                            </li>
                            <li>Carefully record the amount of used oil placed into and removed from storage devices.
                                Recordkeeping plays an important role in leak detection for ASTs, USTs, and drums.
                            </li>
                            <li>Have constructed secondary containment around our drums/tanks with a capacity for 100
                                percent of the contents of the drums we store; the base of the containment area is
                                sloped so
                                that any spilled oil may be recollected and removed.
                            </li>
                            <li>Equip storage containers with wide-mouth, long-necked funnels to reduce spills during
                                QUg.
                            </li>
                            <li>Equip storage containers with a pressure relief valve to reduce a buildup of pressure,
                                which
                                could cause leaks.
                            </li>
                            <li>Keep absorbent materials such as kitty litter and sawdust to clean up any spills that
                                occur.
                            </li>
                        ...
                        <ul>
                            <li>Recycling used oil cashes in on either its lubricating value or heat value. We use this
                                method of management whenever possible because it is easier to do and more cost
                                effective
                                than properly disposing of used oil.
                            </li>
                            <li>At this facility, we recycle our used oil by having it hauled away by a state approved
                                used
                                oil company method because we do not recycle it or use it for any other function
                                on-site.
                            </li>
                        </ul>
                        <p><i>Responding to Releases of Used Oil</i></p>
                        <ul>
                            <li>Even though all steps have been taken to prevent leaks or spills from occurring, this
                                company is also prepared to respond to spills of used oil. We instruct workers to use
                                the
                                following protocol to manage spills of used oil and provide any necessary equipment:
                            </li>
                            <li> Stop the release. This action will vary depending on why the release is occurring. For
                                example, if the spill occurs because a 55-gallon drum has been knocked over, the drum
                                should
                                be righted to stop more used oil from being released.
                            </li>
                            <li>If the spill occurs because a valve on a storage device has been left open, the valve
                                should
                                be closed. If a leak is a result of a puncture in the tank or drum, rags or similar
                                materials should be used to plug the leak.
                            </li>
                            <li>Contain the release. We strive to prevent the used oil that has been released from
                                spreading. For example, a sorbent, such as kitty litter or sawdust, should be spread
                                over
                                the spilled used oil.
                            </li>
                            <li>Clean up the release. Depending on the extent of the release, cleaning up the used oil
                                can
                                be a simple or a complicated task. For small spills on the ground, the soil can be dug
                                up
                                and disposed of. (The soil must be tested to determine if it exhibits hazardous
                                characteristics.) For larger spills where puddles of used oil have formed, vacuum-type
                                machinery can be used to collect the used oil before the soil is dug up for disposal.
                                Because releases that contaminate a great deal of soil or ground or surface water are
                                very
                                difficult to clean up, this company contacts professionals to conduct the cleanup
                                operation.
                            </li>
                            <li>Properly manage the used oil that has been cleaned up. Any leaked or spilled used oil is
                                managed just like any other used oil under 40 CFR 279.
                            </li>
                            <li>Properly manage the solid materials generated during the cleanup. We place solid
                                materials
                                used to clean up a spill of used oil in a sieve-like container to allow the used oil to
                                drip
                                from the solid materials into a storage device. In addition, we compact the materials to
                                remove the used oil. (Removal is complete when there are no more signs of free-flowing
                                oil.)
                                Materials contaminated with used oil that are burned can be managed in the same manner
                                as
                                used oil.
                            </li>
                            <li>Contaminated materials that will not be burned for energy are tested to determine if
                                they
                                exhibit hazardous waste characteristics. If they do not test hazardous, they are
                                disposed of
                                in a RCRA subtitle D facility. If they are hazardous, they are disposed of in a RCRA
                                subtitle C facility.
                            </li>
                        ...
                        <ul>
                            <li>Although recycling is the best management option for used oil, this company has
                                discovered
                                this option is not feasible. Knowledge of how the used oil was generated or testing has
                                revealed that our used oil is contaminated with none. This used oil is generated in
                                quantities too small to be economically recycled. Therefore, we have chosen to properly
                                dispose of our used oil.
                            </li>
                            <li>Because our used oil is contaminated with halogens in concentrations less than 1,000 ppm
                                or
                                not considered a hazardous waste, we place the used oil in a landfill that accepts
                                industrial wastes and meets RCRA Subtitle D requirements.
                            </li>
                        </ul>
                        <p><i>Managing and Disposing of Used Oil Filters</i></p>
                        <ul>
                            <li>Whenever this company changes the oil in a fleet vehicle, the oil filter is also changed
                                to
                                keep the solid contaminants of the old oil from immediately contaminating the new oil.
                                Used
                                oil filters can contain 10 to 16 ounces of used oil; therefore, proper management of
                                this
                                source of used oil is a concern of this company. Used oil filters are not considered a
                                hazardous waste under RCRA if they are not terne-plated and have been properly drained
                                of
                                oil.
                            </li>
                            <li>When used oil filters are removed from a warm engine, this company uses the Gravity
                                draining
                                - when the filter is removed from the engine, it should be placed with its gasket side
                                down
                                in a drain pan. If the filter has an anti-drain valve, the "dome end" of the filter
                                should
                                be punctured with a screwdriver (or similar device) so that the oil can flow freely. The
                                filter should then be allowed to drain for 12 to 24 hours.
                            </li>
                            <li>We store our drained used oil filters in a covered, rainproof container to prevent used
                                oil
                                from being washed from the filters to the surrounding environment. Our used oil filters
                                are
                                then recycled or properly disposed of.
                            </li>
                        </ul>
                        <p><i>Shipping/Transporting Used Oil</i></p>
                        <ul>
                            <li>The used oil management standards define a used oil transporter as any person who
                                transports
                                used oil, any person who collects used oil from more than one generator and transports
                                the
                                collected oil, and owners and operators of used oil transfer facilities."
                                <strong>{{ config('app.name') }}</strong> utilizes a waste transport company for hauling
                                our
                                used oil and other products for proper disposal. Our transporter has an EPA ID number
                                and
                                complies with all relevant used oil regulations, including keeping tracking records of
                                where
                        ...
                        <ul>
                            ...
                            <li>Check our hauler's qualifications to make sure the hauler takes the oil to a reputable
                                recycling operation.
                            </li>
                            <li>Measure the level of oil in a tank before and after the hauler collects it to be certain
                                the
                                oil collected matches the amount the hauler reports collecting.
                            </li>
                            <li>Make sure a company representative signs and dates the hauler's tracking sheet.</li>
                            <li>Ask for a receipt from the transporter that states how much used oil was collected from
                                our
                                facility and where the used oil will be taken. (These records are not required under the
                                used oil management standards, but may be useful should a problem arise.)
                            </li>
                            <li>Make sure that the hauler maintains storage tanks/containers; labels containers "Used
                                Oil";
                                stores used oil over oil-impervious surfaces; has secondary containment structures in
                                place;
                                stores used oil for no more than 35 days; tests waste in out-of-service tanks; closes
                                out-of-service tanks containing hazardous waste according to EPA standards.
                            </li>
                        </ul>
                        <h2>Employee Training</h2>
                        <p>Although training is not strictly required under the regulations, we have designated a
                            service
                            manager to train personnel who will handle used oil. Direct any questions concerning used
                            oil
                            training to this person.</p>
                        <p>Under this plan, employees are informed of used oil management procedures relevant to the
                            positions in which they work. This training occurs both in the classroom and on the job.</p>
                        <p>We keep records of job titles and written job descriptions for all positions related to used
                            oil
                            management and the names of employees QUg each job. We also keep records describing the type
                            and
                            amount of training provided.</p>
                        <h2>Related Requirements</h2>
                        <p>Related regulations that we must still comply with include:</p>
                        <ul>
                            <li>Spill Prevention Control and Countermeasures requirements (40 CFR 112) Please see
                                related
                                documents for information on how this company meets these additional requirements.
                            </li>
                        </ul>
                        <h2>Recordkeeping</h2>
                        ...
                        <ul>
                            ...
                            <li>Updating the plan as needed by incorporating any necessary changes resulting from major
                                changes in our facility's operation or maintenance.
                            </li>
                        </ul>
                    </article>
                    <article id="rpp">
                        <h1 class="text-arm-blue-600">Respiratory Protection Plan</h1>
                        <h2>Purpose</h2>
                        <p>This respirator program lays out standard operating procedures to ensure the protection of
                            all
                            employees from respiratory hazards in accordance with the requirements of OSHA 29 CFR
                            1910.134.</p>
                        <h2>Administrative Duties</h2>
                        <p>At <strong>{{ config('app.name') }}</strong> our Respiratory Protection Program Administrator
                            is
                            body <strong>{{ $bsm }}</strong>.</p>
                        <p>The body shop manager is also qualified by appropriate training and experience that is
                            commensurate with the complexity of the program to administer or oversee our Respiratory
                            Protection Program and conduct the required evaluations of program effectiveness.</p>
                        <p>Employees may review a copy of our Respiratory Protection Program. It is located in the
                            supervisor's office, <strong>{{ $bsm }}</strong>'s. Our Program Administrator,
                            <strong>{{ $qi }}</strong>, reviews this program periodically to ensure its effectiveness.
                        </p>
                        <h2>Respirator Selection</h2>
                        <p>Respirators are selected on the basis of respiratory hazards to which the worker is exposed
                            and
                            workplace and user factors that affect respirator performance and reliability. All
                            selections
                            are made by the body shop manager.</p>
                        <p>The body shop manager will develop detailed written standard operating procedures governing
                            the
                            selection of respirators using the following guidelines: Select and provide respirators
                            based on
                            respiratory hazard(s) to which a worker is exposed and workplace and user factors that
                            affect
                            respirator performance and reliability.</p>
                        <p>* Select a NIOSH-certified respirator. </p>
                        <p>* Identify and evaluate the respiratory hazard(s) in the workplace, including a reasonable
                            estimate of employee exposures to respiratory hazard(s) and an identification of the
                            contaminant's chemical state and physical form. Consider the atmosphere to be IDLH,</p>
                        <p><strong><i>Immediately Dangerous to Life and Health</i></strong>, if you cannot identify or
                            reasonably estimate employee exposure.</p>
                        <p>* Select respirators from a sufficient number of respirator models and sizes so that the
                            respirator is acceptable to, and correctly fits, the user.</p>
                        <p>When selecting respirators for IDLH atmospheres:</p>
                        <p>* Provide these respirators: - A full facepiece pressure demand SCBA certified by NIOSH for a
                            minimum service life of thirty minutes, or - A combination full facepiece pressure demand
                            supplied-air respirator (SAR) with auxiliary self-contained air supply.</p>
                        <p>* Provide respirators NIOSH-certified for escape from the atmosphere in which they will be
                            used
                            when they are used only for escape from IDLH atmospheres.</p>
                        <p>* Consider all oxygen-deficient atmospheres to be IDLH. Exception: If you can demonstrate
                            that,
                            under all foreseeable conditions, the oxygen concentration can be maintained within the
                            ranges
                            specified in Table II of 29 CFR 1910.134 (i.e., for the altitudes set out in the table),
                            then
                            any atmosphere-supplying respirator may be used.</p>
                        <p>When selecting respirators for atmospheres that are not IDLH:</p>
                        <p>* Provide a respirator that is adequate to protect the health of the employee and ensure
                            compliance with all other OSHA statutory and regulatory requirements, under routine and
                            reasonably foreseeable emergency situations.</p>
                        <p>* Select respirators appropriate for the chemical state and physical form of the
                            contaminant.</p>
                        ...
                        <ul>
                            ...
                            <li>An air-purifying respirator, provided that: (1) The respirator is equipped with an
                                end-of-service-life indicator (ESLI) certified by NIOSH for the contaminant; or (2) If
                                there
                                is no ESLI appropriate for conditions in our workplace, implement a change schedule for
                                canisters and cartridges that is based on objective information or data that will ensure
                                that canisters and cartridges are changed before the end of their service life. Describe
                                in
                                the respirator program the information and data relied upon and the basis for the
                                canister
                        ...
                        <ul>
                            <li>An atmosphere-supplying respirator; or</li>
                            <li>An air-purifying respirator equipped with a filter certified by NIOSH under 30 CFR part
                                11
                                as a high efficiency particulate air (HEPA) filter, or an air-purifying respirator
                                equipped
                                with a filter certified for particulates by NIOSH under 42 CFR 84, or
                            </li>
                            <li>For contaminants consisting primarily of particles with mass median aerodynamic
                                diameters
                        ...
                        <p>For information regarding the types of respirators in use at this facility and their uses,
                            see
                            the table in the full plan.</p>
                        <h2>Medical Evaluations</h2>
                        <p>At <strong>{{ config('app.name') }}</strong>, persons will not be assigned to tasks requiring
                            use
                            of respirators nor fit tested unless it has been determined that they are physically able to
                            perform the work and use the respirator.</p>
                        ...
                        <p>Employees must pass one of the fit test types that follow the protocols and procedures
                            contained
                            in 29 CFR 1910.134 Appendix A.</p>
                        <p>Our workplace-specific fit testing procedures include the following:</p>
                        <ol>
                            <li>The test subject shall be allowed to pick the most acceptable respirator from a
                                sufficient
                                number of respirator models and sizes so that the respirator is acceptable to, and
                                correctly
                                fits, the user.
                            </li>
                            <li>Prior to the selection process, the test subject shall be shown how to put on a
                                respirator,
                                how it should be positioned on the face, how to set strap tension and how to determine
                                an
                                acceptable fit. A mirror shall be available to assist the subject in evaluating the fit
                                and
                            ...
                            <li>The test subject shall be informed that he/she is being asked to select the respirator
                                that
                            ...
                            <li>The test subject shall be instructed to hold each chosen facepiece up to the face and
                                eliminate those that obviously do not give an acceptable fit.
                            </li>
                            <li>The more acceptable facepieces are noted in case the one selected proves unacceptable;
                                the
                                most comfortable mask is donned and worn at least five minutes to assess comfort.
                                Assistance
                                in assessing comfort can be given by discussing the points in the following item A.6. If
                                the
                                test subject is not familiar with using a particular respirator, the test subject shall
                                be
                                directed to don the mask several times and to adjust the straps each time to become
                                adept at
                                setting proper tension on the straps.
                            </li>
                            <li>Assessment of comfort shall include a review of the following points with the test
                                subject
                            ...
                            <li>The following criteria shall be used to help determine the adequacy of the respirator
                                fit:
                                <ul>
                            ...
                            <li>The test subject shall conduct a user seal check, either the negative and positive
                                pressure
                                seal checks described in Appendix B-1 of this section or those recommended by the
                                respirator
                                manufacturer which provide equivalent protection to the procedures in Appendix B-1.
                                Before
                                ...
                                taking in
                                a few slow deep breaths. Another facepiece shall be selected and retested if the test
                                subject fails the user seal check tests.
                            </li>
                            <li>The test shall not be conducted if there is any hair growth between the skin and the
                                facepiece sealing surface, such as stubble beard growth, beard, mustache or sideburns
                                which
                                cross the respirator sealing surface. Any type of apparel which interferes with a
                                satisfactory fit shall be altered or removed.
                            </li>
                            <li>If a test subject exhibits difficulty in breathing during the tests, she or he shall be
                                referred to a physician or other licensed health care professional, as appropriate, to
                                determine whether the test subject can wear a respirator while performing her or his
                                duties.
                            </li>
                            <li>If the employee finds the fit of the respirator unacceptable, the test subject shall be
                                given the opportunity to select a different respirator and to be retested.
                            </li>
                            <li>Exercise regimen. Prior to the commencement of the fit test, the test subject shall be
                                given
                                a description of the fit test and the test subject's responsibilities during the test
                                procedure. The description of the process shall include a description of the test
                                exercises
                                that the subject will be performing. The respirator to be tested shall be worn for at
                                least
                                5 minutes before the start of the fit test.
                            </li>
                            <li>The fit test shall be performed while the test subject is wearing any applicable safety
                                equipment that may be worn during actual respirator use which could interfere with
                                respirator fit.
                            </li>
                            <li>Test Exercises. (a) The following test exercises are to be performed for all fit testing
                                methods prescribed in this appendix, except for the CNP method. A separate fit testing
                                ...
                                <ul>
                                    <li>(1) Normal breathing. In a normal standing position, without talking, the
                                        subject
                                        shall breathe normally.
                                    </li>
                                    <li>(2) Deep breathing. In a normal standing position, the subject shall breathe
                                        slowly
                                        and deeply, taking caution so as not to hyperventilate.
                                    </li>
                                    <li>(3) Turning head side to side. Standing in place, the subject shall slowly turn
                                    ...
                                    <li>(4) Moving your head up and down. Standing in place, the subject shall slowly
                                        move
                                        his/her head up and down. The subject shall be instructed to inhale in the up
                                        position (i.e., when looking toward the ceiling).
                                    </li>
                                    <li>(5) Talking. The subject shall talk out loud slowly and loud enough so as to be
                                        ...
                                        song.
                                        Rainbow Passage When the sunlight strikes raindrops in the air, they act like a
                                        prism and form a rainbow. The
                                        rainbow is a division of white light into many beautiful colors. These take the
                                        shape of a long
                                        round arch, with its path high above, and its two ends apparently beyond the
                                        horizon. There is,
                                        according to legend, a boiling pot of gold at one end. People look, but no one
                                        ever
                                        finds it.
                                        When a man looks for something beyond reach, his friends say he is looking for
                                        the
                                        pot of gold
                                        at the end of the rainbow.
                                    </li>
                                    <li>(6) Grimace. The test subject shall grimace by smiling or frowning. (This
                                        applies
                                        only to QNFT testing; it is not performed for QLFT.)
                                    </li>
                                    <li>(7) Bending over. The test subject shall bend at the waist as if he/she were to
                                        touch his/her toes.
                                        Jogging in place shall be substituted for this exercise in those test
                                        environments
                                        such as shroud
                                        type QNFT or QLFT units that do not permit bending over at the waist.
                                    </li>
                                    <li>(8) Normal breathing. Same as exercise (1).</li>
                                    <li>(b) Each test exercise shall be performed for one minute except for the grimace
                                        exercise which
                                        shall be performed for 15 seconds. The test subject shall be questioned by the
                                        test
                                        conductor
                                        regarding the comfort of the respirator upon completion of the protocol. If it
                                        has
                                        become
                                        unacceptable, another model of respirator shall be tried. The respirator shall
                                        not
                                        be adjusted
                                        once the fit test exercises begin. Any adjustment voids the test, and the fit
                                        test
                                        must be
                                        repeated. B.
                                    </li>
                        ...
                        <h2>Proper Use Procedures</h2>
                        <p>Once the respirator has been properly selected and fitted, its protection efficiency must be
                            maintained for proper use according to 29 CFR 1910.134(g). Our company ensures with written
                            procedures that respirators are used properly in the workplace. Our proper respirator use
                            procedures are:</p>
                        <p>CHECKLIST TO ENSURE PROPER RESPIRATOR USAGE BASED ON OSHA 29 CFR 1910.134(g): </p>
                        <p>Facepiece Seal Protection</p>
                        <p>* Do not permit respirators with tight-fitting facepieces to be worn by employees who
                            have:</p>
                        <ul>
                            <li>Facial hair that comes between the sealing surface of the facepiece and the face or that
                                interferes with valve function; or
                            </li>
                            <li>Any condition that interferes with the face-to-facepiece seal or valve function.</li>
                        </ul>
                        <p>* If an employee wears corrective glasses or goggles or other personal protective equipment,
                            ensure that such equipment is worn in a manner that does not interfere with the seal of the
                            facepiece to the face of the user.</p>
                        <p>* For all tight-fitting respirators, ensure that employees perform a user seal check each
                            time
                            they put on the respirator using the procedures in 29 CFR 1910.134 Appendix B-1 (User Seal
                            Check
                            Procedures) or procedures recommended by the respirator manufacturer that you can
                            demonstrate
                            are as effective as those in Appendix B-1.</p>
                        <p>Continuing Respirator Effectiveness</p>
                        <p>* Appropriate surveillance must be maintained of work area conditions and degree of employee
                            exposure or stress. When there is a change in work area conditions or degree of employee
                            exposure or stress that may affect respirator effectiveness, reevaluate the continued
                            effectiveness of the respirator.</p>
                        <p>* Ensure that employees leave the respirator use area:</p>
                        <ul>
                            <li>To wash their faces and respirator facepieces as necessary to prevent eye or skin
                                irritation
                            ...
                            <li>If the employee detects vapor or gas breakthrough, changes in breathing resistance, or
                                leakage of the facepiece, replace or repair the respirator before allowing the employee
                                to
                                return to the work area.
                            </li>
                        </ul>
                        <p>Procedures for IDLH Atmospheres Ensure that:</p>
                        <p>* One employee or, when needed, more than one employee is located outside the IDLH
                            atmosphere; </p>
                        <p>* Visual, voice, or signal line communication is maintained between the employee(s) in the
                            IDLH
                            atmosphere and the employee(s) located outside the IDLH atmosphere;</p>
                        <p>* The employee(s) located outside the IDLH atmosphere are trained and equipped to provide
                            effective emergency rescue;</p>
                        <p>* The employer or designee is notified before the employee(s) located outside the IDLH
                            atmosphere
                            enter the IDLH atmosphere to provide emergency rescue;</p>
                        <p>* The employer or designee authorized to do so by the company, once notified, provides
                            necessary
                            assistance appropriate to the situation; </p>
                        <p>* Employee(s) located outside the IDLH atmospheres are equipped with:</p>
                        <ul>
                            <li>Pressure demand or other positive pressure SCBAs, or a pressure demand or other positive
                                pressure supplied-air respirator with auxiliary SCBA; and either:
                            </li>
                            <li>Appropriate retrieval equipment for removing the employee(s) who enter(s) these
                                hazardous
                            ...
                            <li>Equivalent means for rescue where retrieval equipment is not required under the bullet
                                item
                                above this one.
                            </li>
                        </ul>
                        <p>Procedures for Interior Structural Firefighting</p>
                        <p>In addition to the requirements set forth in the row above for Procedures for IDLH
                            Atmospheres,
                            in interior structural fires, ensure that:</p>
                        <p>* At least two employees enter the IDLH atmosphere and remain in visual or voice contact with
                            one
                            another at all times;</p>
                        <p>* At least two employees are located outside the IDLH atmosphere</p>
                        <h2>Maintenance and Care Procedures</h2>
                        <p>Our company provides each respirator user with a respirator that is clean, sanitary, and in
                            good
                            working order, according to the requirements in 29 CFR 1910.134(h)(1). We have created the
                            following cleaning schedule(s) to be used for each respirator: Respirator issued for the
                            exclusive use of an employee must be cleaned and disinfected as often as necessary to be
                            maintained in a sanitary condition.</p>
                        <p>* Respirators issued to more than one employee must be cleaned and disinfected before being
                            worn
                            by different individuals.</p>
                        <p>* Respirators maintained for emergency use must be cleaned and disinfected after each
                            use.</p>
                        <p>* Respirators used in fit testing and training must be cleaned and disinfected after each
                            use.</p>
                        <p>We ensure that respirators are stored according to 29 CFR 1910.134(h)(2). They are packed or
                            stored in employees’ lockers to prevent deformation of the facepiece and exhalation
                            valve.</p>
                        <p>We inspect respirators according to the requirements in 29 CFR 1910.134(h)(3). We have
                            created
                            the following inspection schedule(s) to be used for each respirator: All types of
                            respirators
                            used in routine situations must be inspected before each use and during cleaning.</p>
                        <p>* Respirators maintained for use in emergency situations must be inspected at least monthly
                            and
                            in accordance with the manufacturer's recommendations, and checked for proper function
                            before
                            and after each use.</p>
                        <p>* Emergency escape-only respirators must be inspected before being carried into the workplace
                            for
                            use.</p>
                        <p>See the attached respirator inspection records.</p>
                        <p>Respirators that fail an inspection or are otherwise found to be defective are removed from
                            service and are discarded or repaired or adjusted according to the procedures in 29 CFR
                            1910.134(h)(4).</p>
                        <p>We use the following discarding procedures: they are discarded immediately.</p>
                        <h2>Air Quality Procedures</h2>
                        <p>The following detailed procedures ensure adequate air quality, quantity, and flow of
                            breathing
                            air for atmosphere-supplying respirators and include coverage of the OSHA requirements for
                            breathing air quality and use in 29 CFR 1910.134(I): N/A.</p>
                        <h2>Training</h2>
                        <p>Employee training is an important part of the respiratory protection program and is essential
                            for
                            correct respirator use. Our training program is provided by assigned outside vendors and
                        ...
                        <p>At <strong>{{ config('app.name') }}</strong>, program evaluation is performed annually by our
                            body shop manager according to 29 CFR 1910.134(l).</p>
                        <h2>Appendices</h2>
                        <p>The following documents are attached to this Respiratory Protection Program: none</p>
                    </article>
                    <article id="bpp">
                        <h1 class="text-arm-blue-600">Bloodborne Pathogens Plan</h1>
                        <h2>Purpose</h2>
                        <p>Our exposure control plan (ECP) is provided to eliminate or minimize occupational exposure to
                            bloodborne pathogens in accordance with OSHA standard 29 CFR 1910.1030, "Occupational
                            Exposure
                            to Bloodborne Pathogens."</p>
                        <h2>Administrative Duties</h2>
                        <p><strong>{{ $qi }}</strong>, is responsible for the implementation of the ECP and is
                            responsible
                            for maintaining, reviewing, and updating the ECP at least annually.
                            <strong>{{ $qi }}</strong>
                            is responsible for maintaining and providing all necessary equipment and supplies and also
                            responsible for ensuring that all medical actions are performed and for maintaining
                            appropriate
                            records. <strong>{{ $qi }}</strong> is responsible for training and allowing ECP access for
                            appropriate personnel.</p>
                        <h2>Methods of Implementation and Control</h2>
                        <p>The plan indicates job classifications in which some employees at our establishment have
                            occupational exposure. Universal Precautions All employees utilize universal precautions</p>
                        <p><i>Exposure Control Plan </i></p>
                        <p>Covered employees receive an explanation of this ECP during their initial training, and
                            annually.
                            Employees may review this plan at any time during their work shifts by contacting
                            <strong>{{ $qi }}</strong>. The plan indicates which devices have been identified as
                            candidates
                            for our use. <strong>{{ $qi }}</strong> solicits input from non-managerial employees
                            responsible
                            for direct patient care in the identification, evaluation, and selection of effective
                            engineering and work practice controls. <strong>{{ $qi }}</strong> documents all
                            solicitation in
                            the ECP and indicates the engineering and work practice controls identified during
                            solicitation
                            in our annual reviews.</p>
                        <p><i>Engineering and Work Practice Controls</i></p>
                        <p>The plan indicates which specific engineering controls and work practice controls are used.
                            The
                            controls include how sharps disposal containers are maintained. The plan also indicates how
                            we
                            identify the need for changes in engineering control and work practices, and evaluates the
                            need
                            for new procedures or new products. <strong>{{ $qi }}</strong> is responsible for the
                            effective
                            implementation controls recommendations.</p>
                        <p><i>Personal Protective Equipment (PPE)</i></p>
                        <p>PPE is provided to our employees at no cost to them. <strong>{{ $qi }}</strong> provides
                            appropriate PPE training.</p>
                        <p><i>Housekeeping</i></p>
                        <p>Our plan indicates the steps taken to effectively contain regulated wastes, including sharps,
                            during handling.</p>
                        <p><i>Labels</i></p>
                        <p>The plan indicates which labeling method(s) is used in this facility.
                            <strong>{{ $sm }}</strong>,
                            ensures that proper, effective labeling is used. The local health department and
                            <strong>{{ config('app.name') }}</strong> provides training to employees on hepatitis B
                            vaccinations, addressing the safety, benefits, efficacy, methods of administration, and
                            availability. Personal physician provides vaccinations at the physicians’ location.</p>
                        <h2>Hepatitis B Vaccination Post-exposure and Evaluation</h2>
                        <p>Should an exposure incident occur, employees are to contact <strong>{{ $qi }}</strong>. We
                            provide immediate, confidential medical evaluation and follow-up after initial first aid.
                        </p>
                        <p><i>Administration of Post-Exposure Evaluation and Follow-up</i></p>
                        <p><strong>{{ $qi }}</strong> ensures that the responsible health care professional(s) is given
                            a
                            copy of OSHA's bloodborne pathogens standard, and <strong>{{ $qi }}</strong> provides the
                            employee with a copy of the evaluating health care professional's written opinion.</p>
                        ...
                        <h2>Employee Training</h2>
                        <p><strong>{{ $qi }}</strong> conducts training for employees who have occupational exposure to
                            bloodborne pathogens. The plan indicates what topics are covered in the training, and where
                            training materials.</p>
                        <h2>Recordkeeping</h2>
                        <p><i>Training Records</i></p>
                        <p>Training records are kept for at least three years at <strong>{{ $qi }}</strong> office
                            location.
                            The plan describes which training records are included.</p>
                        <p><i>Medical Records</i></p>
                        <p><strong>{{ $qi }}</strong> is responsible for maintaining the required medical records. These
                            records are kept in the human resource office for at least the duration of employment plus
                            30
                            years.</p>
                        <p><i>OSHA Recordkeeping</i></p>
                        <p>If an exposure incident occurs, it is evaluated, and <strong>{{ $qi }}</strong> determines if
                            the
                            case meets OSHA's Recordkeeping Requirements.</p>

                    </article>
                    <article id="ppe">
                        <h1 class="text-arm-blue-600">Personal Protective Equipment</h1>
                        <h2>Purpose</h2>
                        <p>The purpose of this Personal Protective Equipment (PPE) Program is to document the hazard
                            assessment, protective measures in place, and PPE in use at this company.</p>
                        <p>While OSHA's Personal Protective Equipment regulation, found at 29 CFR 1910.132-.140 (Subpart
                            I),
                            does not explicitly require a written Personal Protective Equipment (PPE) Program,
                            <strong>{{ config('app.name') }}</strong> has developed a written PPE program to document
                            and
                            specify all information relative to our PPE needs.</p>
                        <p>The <strong>{{ $sm }}</strong>, is the program coordinator, acting as the representative of
                            the
                            plant manager, who has overall responsibility for the program. The service manager will
                            designate appropriate dealership supervisors to assist in training employees and monitoring
                            their use of PPE. This written plan is kept in service department office will review and
                            update
                            the program as necessary. Copies of this program may be obtained from the service manager’s
                            office.</p>
                        <h2>Hazard Assessment</h2>
                        <p>In order to assess the need for PPE, the Safety Manager, with other appropriate managers’ and
                            employees will help:</p>
                        <ul>
                            <li>identifies job classifications where exposures occur or could occur, and</li>
                            <li>conducts a walk-through survey of workplace areas where hazards exist or may exist to
                                identify sources of hazards to employees.
                            </li>
                        </ul>
                        <p>During the walk-through survey the Safety Manager observes and records the hazards along with
                            PPE
                            currently in use (type and purpose). The Safety Manager organizes the data and information
                            for
                            use in the assessment of hazards to analyze the hazards and enable proper selection of
                            protective equipment.</p>
                        <p>The Safety Manager documents the hazard assessment according to 29 CFR 1910.132(d)(2).</p>
                        <h2>Selection Guidelines</h2>
                        <p>Once any hazards have been identified and evaluated through hazard assessment, protective
                            equipment is chosen according to the selection guidelines in Appendix B to Subpart I of 29
                            CFR
                            1910.</p>
                        <p>It is the responsibility of the Safety Manager to reassess the workplace hazard situation as
                            necessary, to identify and evaluate new equipment and processes, to review accident records,
                            and
                            reevaluate the suitability of previously selected PPE. This reassessment will take place as
                            needed, but at least every quarter during inspection of the facility and work
                            environment.</p>
                        <h2>Employee Training</h2>
                        <p>The Safety Manager/supervisor provides training, according to 29 CFR 1910.132(f), for each
                            employee who is required to use personal protective equipment.</p>
                        <p>Because failure to comply with company policy concerning PPE can result in OSHA citations and
                            fines as well as employee injury, an employee who does not comply with this program will be
                            disciplined for noncompliance according to the following schedule: employee will be subject
                            to
                            disciplinary action up to and including termination as determined by the shop foreman and
                            service manager.</p>
                        <h2>Cleaning and Maintenance</h2>
                        <p>PPE is to be inspected, cleaned, and maintained by employees at regular intervals as part of
                            their normal job duties so that the PPE provides the requisite protection.</p>
                        <p>Supervisors are responsible for ensuring compliance with cleaning responsibilities by
                            employees.</p>
                        <h2>PPE Specific Information</h2>
                        <p>Employees in the following designated work areas are required to wear goggles/face
                            shields:</p>
                        <p><span class="italic underline">Eye Protection</span> - Work Area: service bay areas and parts
                            department.</p>
                        <p><span class="italic underline">Safety Shields / Goggles</span> - Work Area Hazard: grinding,
                            welding flash, chemical splash, high temperature, splash from molten metal’s, hammering,
                            metal
                            fragments.</p>
                        <p>Type of goggles/face shield: covered goggles, direct ventilation, face shields, welding
                            helmets.</p>
                        <p>Employees from temporary work agencies and contractors are required to wear goggles/face
                            shields
                            if assigned to work in the designated work areas.</p>
                        <h2>PPE Specific Information</h2>
                        <p><i>Foot Protection Safety Shoes</i></p>
                        <p>Employees in the following designated work areas are required to wear OSHA approved safety
                            shoes:</p>
                        ...
                        <p>Type of safety shoe: Rubber heeled boots with Nitrile or Neoprene boots soles to protect
                            against
                            slipping on wet or oily floors. Also protects against chemical exposure. Also will have
                            steel-toed shoes to protect against falling objects.</p>
                        <p>Employees from temporary work agencies and contractors are required to wear safety shoes if
                            assigned to work in the designated work areas.</p>
                        <p>Members of the Emergency Response Team are required to wear safety footwear when responding
                            to
                            fire emergency situations.</p>
                        <p>All employees who work in designated work areas and/or job assignments are responsible for
                            purchasing and wearing safety shoes to comply with this policy. Purchase of shoes is done by
                            Employees needing to purchase their own safety shoes through a local merchant as a condition
                            of
                            employment.</p>
                        <h2>PPE Specific Information</h2>
                        ...
                        <p>Work area: service technicians and parts department employees.</p>
                        <p>Hazard: working in and around car repair, moving boxes and other parts around in the parts
                            department, utilizing gloves for welding.</p>
                        <p>Type of glove: gloves will be used and assessed based on the type of job function being
                            employed.
                            Safety suppliers can help examine the attributes of the various types of gloves and advise
                            accordingly.</p>
                        <p>Employees from temporary work agencies and contractors are required to wear protective gloves
                            if
                            Employees in the following designated work areas are required to wear protective gloves:</p>
                        <p>Work area: service technicians and parts department employees. </p>
                        <p>Hazard: working in and around car repair, moving boxes and other parts around in the parts
                            department, utilizing gloves for welding. </p>
                        <p>Type of glove: gloves will be used and assessed based on type of job function being employed.
                            Safety suppliers can help examine the attributes of the various types of gloves and advise
                            accordingly.</p>
                        <p>Employees from temporary work agencies and contractors are required to wear protective gloves
                            if
                        ...
                        <p>Work area: service technicians and parts department employees. </p>
                        <p>Hazard: hair from oil, grease, water, dirt and sparks protect the head from hot exhaust
                            systems,
                            hot oil, sharp protruding objects and falling pipes, mufflers or other vehicle parts. They
                            easily adapt for the wearing of eye goggles and safety glasses. Parts department employees
                            can
                            have parts and equipment fall off storage shelves when removing or storing such items.</p>
                        <p>Type of hard hat: bump caps which will protect the employees from the items mentioned
                            above.</p>
                        <p>Employees from temporary work agencies and contractors are required to wear hard hats if
                            assigned
                            to work in the designated work areas.</p>
                    </article>
                    <article id="cgp">
                        <h1 class="text-arm-blue-600">Compressed Gas Plan</h1>
                        <h2>Purpose</h2>
                        <p>It is the policy of <strong>{{ config('app.name') }}</strong> to permit only trained and
                            authorized employees to handle, store,
                        ...
                        <p>The service manager is responsible for developing and maintaining this written Compressed
                            ...
                            dashboard.</p>
                        <h2>List of Compressed Gases and Equipment</h2>
                        ...
                        <p><span class="italic underline">Handling Procedures</span>- We follow the safe handling
                            procedures
                            found in the CGA pamphlet
                            series, including the P-1-1991 pamphlet.</p>
                        <p><span class="italic underline">Storage Procedures</span> - We follow the safe storage
                            procedures
                            found in the CGA pamphlet series,
                            including the P-1-1991 pamphlet.</p>
                        <p><span class="italic underline">Usage Procedures</span> - We follow the safe storage
                            procedures
                            found in the CGA pamphlet series,
                            including the P-1-1991 pamphlet.</p>
                        <h2>Training Program</h2>
                        ...
                        <p>The service manager is responsible for maintaining records of individuals trained and
                            certified
                    ...
                    <article id="wcp">
                        <h1 class="text-arm-blue-600">Welding &amp; Cutting Procedures</h1>
                        <h2>Purpose</h2>
                        ...
                        <p>The service manager is responsible for developing and maintaining the written Welding &amp;
                            Cutting Procedures. These procedures are kept at the following location: shop foreman&#39;s
                            office.</p>
                        <h2>Welding and Cutting Equipment</h2>
                        <p>Our company uses welding and cutting equipment according to the table in the full plan.</p>
                        <h2>Training</h2>
                        <p>It is the policy of <strong>{{ config('app.name') }}</strong> to permit only trained and
                            authorized personnel to operate
                        ...
                        <h2>Inspections</h2>
                        <p>Following is a list of possible inspection items to be aware of before welding or
                            cutting:</p>
                        <ul>
                        ...
                        <ul>
                            ...
                            <li>Is care used in handling and storage of cylinders, safety valves, relief valves, etc.,
                                to
                            ...
                            <li>Is it prohibited to use cylinders as rollers or supports? 29 CFR 1910.253(b)(5)(ii)(K)
                            </li>
                            ...
                            <li>Are fuel gas cylinders and oxygen cylinders separated by distance, fire resistant
                                barriers,
                        ...
                        <ul>
                            ...
                            <li>Are approved safety glasses required to be worn at all times in areas where there is a
                                risk of eye injuries such as punctures, abrasions, contusions, or burns? 29 CFR
                                1910.133(a)(2)
                            </li>
                        ...
                        <ul>
                            ...
                            <li>Are provisions made to never crack a fuel-gas cylinder valve near sources of ignition?
                                29
                            ...
                            <li>Before hot work is begun, are used drums, barrels, tanks, and other containers so
                                thoroughly cleaned that no substances remain that could explode, ignite, or produce
                                toxic
                        ...
                        <ul>
                            ...
                            <li>Are all fire extinguishers inspected and recharged regularly, and noted on the
                                inspection
                        ...
                        <h2>Maintenance</h2>
                        <p><strong>{{ $pm }}</strong>, <strong>titlex3</strong> complete(s) a receiving or delivery
                            inspection whenever our company
                        ...
                        <p>Our company posts signs as follows: 29 CFR 1910.252 General requirements for welding,
                            cutting, and brazing--- (b)(2)(ii)(G) Lenses shall bear some permanent distinctive marking
                            by
                            which the source and shade may be readily identified.</p>
                        <p>(b)(4)(vii) Warning sign. After welding operations are completed, the welder shall mark the
                            hot
                            metal or provide some other means of warning other workers.</p>
                        <p>(c)(1)(iv) Precautionary labels. A number of potentially hazardous materials are employed in
                            fluxes, coatings, coverings, and filler metals used in welding and cutting or are released
                            to
                            the
                            atmosphere during welding and cutting. These include but are not limited to the materials
                            itemized in paragraphs (c)(5) through (c)(12) of this section. The suppliers of welding
                            materials
                            shall determine the hazard, if any, associated with the use of their materials in welding,
                            cutting,
                            etc.</p>
                        <p>(c)(1)(iv)(A) All filler metals and fusible granular materials shall carry the following
                            notice,
                            as a
                        ...
                        <h2>Recordkeeping</h2>
                        <p><strong>{{ $sm }}</strong>, <strong>titlex2</strong> is responsible for maintaining the
                            following
                            records: any service or
                            maintenance records. These records are maintained in shop foreman&#39;s office for 3 years.
                        </p>
                        <h2>Appendix A</h2>
                        ...
                        <ul>
                            ...
                            <li>Related plans (i.e., confined space, personal protective equipment, fire prevention,
                                emergency
                                action, electrical safety, toxic and hazardous substances, hazard communication, etc.);
                                and
                            </li>
                    ...
                    <article id="fpp">
                        <h1 class="text-arm-blue-600">Fire Prevention Plan</h1>
                        <h2>Purpose</h2>
                        <p>OSHA&#39;s Fire Prevention Plan regulation, found at 29 CFR 1910.38(b), requires
                            <strong>{{ config('app.name') }}</strong>, to
                            have a written fire prevention plan (FPP). This plan applies to all operations in our
                            company
                            where employees may encounter a fire.</p>
                        <p>This Fire Prevention Plan (FPP) is in place at this company to control and reduce the
                            possibility
                        ...
                        <ul>
                            ...
                            <li>The type of fire protection equipment or systems which can control a fire involving
                                them.
                            </li>
                            <li>Regular job titles of personnel responsible for maintenance of equipment and systems
                                installed to prevent or control ignition of fires and for control of fuel source
                                hazards.
                            </li>
                        </ul>
                        <p>Under this plan, our employees will be informed of the plan&#39;s purpose, preferred means of
                            ...
                            situations, and the alarm system. The plan is closely tied to our Emergency Action Plan
                            where
                        ...
                        <p><strong>{{ $qi }}</strong>, is the Plan Coordinator, acting as the representative of the
                            Facility
                            Manager, who has overall responsibility for the plan. The written plan is kept in Qualified
                            Individual’s office and or online compliance dashboard. <strong>{{ $qi }}</strong>, will
                            review
                            and
                        ...
                        <p>If after reading this plan, you find that improvements can be made, please contact the Plan
                            Coordinator, <strong>{{ $qi }}</strong>. We encourage all suggestions because we are
                            committed
                            to the success of our Fire Prevention Plan. We strive for clear understanding, safe
                            behavior,
                            and
                            involvement in the plan from every level of the company.</p>
                        <h2>Plan Coordinator Responsibilities</h2>
                        <p>Here at <strong>{{ config('app.name') }}</strong>, the Plan Coordinator,
                            <strong>{{ $qi }}</strong>, or designee, is responsible
                        ...
                        <ol>
                            ...
                            <li>Distribute procedures for reporting a fire, the location of fire exits, and evacuation
                                routes
                                to each employee.
                            </li>
                            ...
                            <li>Keep key management personnel home telephone numbers in a safe place in the facility
                                for immediate use in the event of a fire. Distribute a copy of the list to key persons
                                to be
                            ...
                            <li>If evacuation is deemed necessary, the Plan Coordinator ensures that:
                                <ul>
                                    <li>All employees are notified and evacuated and a head count is taken to confirm
                                        total
                                    ...
                                    <li>The building owner/superintendent is contacted, informed of the action taken,
                                        and
                                        asked
                                        to assist in coordinating security protection.
                                    </li>
                                    <li>In locations where the building owner/superintendent is not available, security
                                        measures
                        ...
                        <p>In addition, the Plan Coordinator is responsible for duties unique to this facility. Storage
                            of
                            used
                            oil drums outside of service department, storage of cars and truck on site, extra ordinary
                            amount
                        ...
                        <p>Fire can be represented by a simple equation: Fire = Ignition Source + Fuel + Oxygen. Without
                            any one of these three elements, a fire cannot start. Likewise, during a fire, if you take
                            away
                            any
                            one of these three elements, you can successfully put out a fire. It is our company&#39;s
                            intent
                            to
                        ...
                        <p>Employees are to transfer flammable liquids to approved containers and watch for spills. Oil-
                            soaked rags must be treated differently than general paper trash in office areas and
                            disposed of
                            in proper steel can receptacles to prevent from being ignited.</p>
                        <p>Fuel is used throughout the facility as an energy source for various systems or equipment.
                            This
                            fuel can be a significant fire hazard and must be monitored and controlled.</p>
                        <p>The service and parts manager along with, <strong>{{ $qi }}</strong>, will be responsible for
                            the
                            overall state of facility and the reduction of fuel hazards in all areas of the facility and
                            be
                            responsible for oversight of housekeeping duties that reduce and control fuel source hazards
                            such as accumulation of flammable and combustible materials like trash, oily rags, or any
                            other
                            fire hazards. Your parts manager will be responsible for control of fuel source hazards in
                            the
                            loading dock area and be responsible for control of fuel source hazards in the distribution
                            area.</p>
                        ...
                        <p>Flammable or combustible materials and other fuel sources may not ignite on their own without
                            ...
                            sparks and static; friction; and bombs and arson. Other ignition sources include lightning,
                            static,
                        ...
                        <ul>
                            <li>Class A—This common fire involves ordinary materials like wood, paper, rubber, and
                                plastics.
                            ...
                            <li>Class C—This is an electrical fire. Carbon dioxide or dry chemicals extinguish this
                                fire.
                            </li>
                        ...
                        <p><strong><i>At this location the use of ABC class fire extinguishers are utilized along with
                                    class
                                    A</i></strong></p>
                        ...
                        <h2>Maintenance of Fire Protection Equipment</h2>
                        <p>Once hazards are evaluated and equipment is installed to control them, the equipment must be
                            ...
                            personnel are responsible for maintaining equipment and systems installed to prevent or
                            control
                        ...
                        <h2>Housekeeping Procedures</h2>
                        <p>Our company controls accumulations of flammable and combustible waste materials and
                            residues so that they do not contribute to a fire. We have identified the following
                            potential
                        ...
                        <p>Keeping the floors free of paper or saw dust, storing oily rags in specially designed
                            containers,
                        ...
                        <p>At the time of a fire, employees should know what type of evacuation is necessary and what
                            their role is in carrying out the plan. In cases where the fire is large, total and
                            immediate
                            evacuation of all employees is necessary. In smaller fires, a partial evacuation of
                            nonessential
                            employees with a delayed evacuation of others may be necessary for continued operation. We
                            must be sure that employees know what is expected of them during a fire to assure their
                            safety.</p>
                        ...
                        <ul>
                            ...
                            <li>Measures to contain fire (e.g., closing office doors, windows, etc. in immediate
                                vicinity)
                            </li>
                        ...
                        <p>The Plan Coordinator provides training for each employee who is required to use fire
                            protection
                        ...
                        <p>Employees must demonstrate an understanding of the training and the ability to use the
                            equipment properly before they are allowed to perform work requiring the use of the
                            equipment.</p>
                        <p>If the Plan Coordinator has reason to believe an employee does not have the understanding or
                            skill required, the employee must be retrained and ensures that the employee has received
                            and
                    ...
                    <article id="mesg">
                        <h1 class="text-arm-blue-600">Machine Equipment Safety/Guarding</h1>
                        <h2>Purpose</h2>
                        ...
                        <p>This written Machine/Equipment Safety and Guarding Plan describes methods and practices for
                            ...
                            managers, supervisors, and employees at dealershipx. This written plan is intended to be
                            used
                            to:</p>
                        <ul>
                            ...
                            <li>Provide a consistent format for training employees on the proper procedures to be
                                used,
                            </li>
                            <li>Minimize the possibility of injury or harm to our employees, and</li>
                            <li>Demonstrate <strong>{{ config('app.name') }}&#39;s</strong> compliance with machine
                                safety
                                and equipment usage
                        ...
                        <h2>Administrative Duties</h2>
                        <p><strong>{{ $sm }}</strong>, our company&#39;s <strong>titlex2</strong>, is responsible for
                            developing and maintaining this
                            written Machine/Equipment Safety and Guarding Plan. This person is solely responsible for
                            all
                            facets of the plan and has full authority to make necessary decisions to ensure the success
                            of
                            this plan. The service manager is also qualified, by appropriate training and experience
                            that is
                        ...
                        <p>If, after reading this plan, you find that improvements can be made, please contact your
                            ...
                            company.</p>
                        <h2>List of Machinery, Tools, and Equipment</h2>
                        ...
                        <h2>Pre-Operational Procedures</h2>
                        ...
                        <ul>
                            <li>Prevent contact - The guards prevent hands, arms, or any part of an employee&#39;s body
                                or
                            ...
                            <li>Secure - Guards are not easy to remove or alter. Guards and safety devices are made of
                                durable material that will withstand the conditions of normal use. They are firmly
                                secured
                                to the machine.
                            </li>
                        ...
                        <p>If a lock or tag is in place on a piece of machinery or equipment, it may not be removed and
                            the
                        ...
                        <p>The company training program includes classroom instruction and operational training on each
                            specific piece of machinery and equipment to be utilized by the employee in the assigned
                            work
                            area.</p>
                        <p>The following individuals receive training: All fixed operations employees/service
                            technicians’
                            will receive training regarding their work space area and any other equipment that is needed
                            to
                            perform their job functions.</p>
                        <p><strong>{{ $qi }}</strong> will identify all new employees in the employee Orientation
                            Program
                            and
                        ...
                        <p>Department management is responsible for scheduling the employee with the Department
                            Operations Trainer to complete the operational training program after successful completion
                            of
                            the classroom training or re-training segment.</p>
                        <h2>New Equipment Start-up Inspection Procedures</h2>
                        ...
                        <p>While work is in progress on installation of new equipment, the following departments, in
                            charge
                            of specific expertise, must be involved from the beginning to the end of the installation
                            process:
                            Service and Parts departments</p>
                        <p>Corrections that need implementation during the installation should be done as needed.</p>
                        <p>Before operation of the equipment in the workplace, all specialty departments must signify
                            that
                            the equipment meets all expectations in their area of concern.</p>
                        <p><strong>{{ $sm }}</strong>, and assigned supervisors are accountable for all phases of
                            installation and
                            for making sure equipment is safe and efficient to run before letting employees operate it.
                        </p>
                        <p>Once service manager and assigned supervisors has verified completion, the equipment can be
                            put into service.</p>
                        <h2>Inspections</h2>
                        <p>Machinery, tools, and equipment will be inspected regularly to ensure safety and
                            serviceability.
                            Management Supervisors and all service technicians working with the machinery inspects all
                            machinery, equipment, cords and accessories according to the following schedule:
                            Quarterly.</p>
                        <h2>Recordkeeping</h2>
                        ...
                        <h2>Program Evaluation</h2>
                        <p>Although we may not be able to eliminate all problems, we try to eliminate as many as
                            possible
                            to improve employee protection and encourage employee safe practices. Therefore,
                            <strong>{{ $sm }}</strong>, is responsible for evaluating and updating this written plan.
                            The
                            evaluation will
                ...
                const observer = new IntersectionObserver(entries => {
                    entries.forEach(entry => {
                        ...
                        if (entry.intersectionRatio > 0) {
                            document.querySelector(`.toc li a[href="#${id}"]`).classList.add('text-arm-orange-500')
                        } else {
                            document.querySelector(`.toc li a[href="#${id}"]`).classList.remove('text-arm-orange-500')
                        }
                    });
                });
