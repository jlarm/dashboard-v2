    ...
    <div class="relative md:flex">
        <div class="w-64 fixed inset-y-0 z-10 flex flex-col pr-6 mt-32 border-r">
            <ul class="toc mt-3 space-y-3 text-sm text-gray-500">
                ...
                <li>
                    <a href="#heat" class="hover:text-arm-orange-600 transition">Heat Illness and Prevention Program</a>
                </li>
            </ul>
        </div>
        <div class="pl-72 relative top-2">
            ...
            <div class="space-y-10 prose max-w-none px-6">
                <article id="eap">
                    ...
                    <div>
                        <h2>Purpose</h2>
                        <p><strong>{{ $store->name }}</strong> is dedicated to the protection of its employees
                        ...
                        <p>OSHA's Emergency Action Plan requirements, found at 29 CFR 1910.38(a), require
                            <strong>{{ $store->name }}</strong> to have a written emergency action plan (EAP).
                        ...
                        <p><strong>{{ $qi }}</strong> (or designee) is the (EAP) Emergency Action Plan administrator,
                            who has
                        ...
                        <p><strong>{{ $qi }}</strong> is responsible for reviewing and updating the plan as necessary.
                            Copies
                        ...
                        <p>The following personnel can be contacted regarding further information about duties under
                            this written Emergency Action Plan:</p>
                        ...
                        <p>Different emergencies call for different alarms to indicate what actions employees should
                            take.
                            <strong>{{ $store->name }}</strong> has established an employee alarm system that
                            complies with 29 CFR 1910.165.
                            <strong>{{ $store->name }}</strong> uses in house fire suppression... We use a
                        ...
                        <ul>
                            ...
                            <li>Reports in to a central checkpoint managed by <strong>{{ $qi }}</strong> or designee,
                                and
                            </li>
                        ...
                        <p>Employees should stay away from windows, but stay inside the building they are in. Employees
                            ...
                            given.</p>
                        <p><strong>{{ $qi }}</strong> or designee will determine when it is safe for employees to leave
                            their
                ...
                <article id="hcp">
                    ...
                    <p>The purpose of this program is to inform interested persons, including employees, that
                        <strong>{{ $store->name }}</strong> is complying with the OSHA Hazard Communication
                    ...
                    <p>The safety and health manager, <strong>{{ $qi }}</strong>, is the program coordinator, acting as
                        the
                    ...
                    <p>The material safety data sheets are kept at the following location(s) in our facility: service
                        department’s supervisor&#39;s office, <strong>{{ $sm }}</strong>. Employees can obtain access to
                        them by
                ...
                <article id="hazwoper">
                    ...
                    <p>At our facility, <strong>{{ $qi }}</strong>, is the person responsible for conducting training.
                        We make
                    ...
                    <p><strong>{{ $sm }}</strong>, is the general supervisor who has the responsibility and authority to
                        direct
                        all hazardous waste operations.</p>
                    <p><strong>{{ $qi }}</strong>, is the site safety and health supervisor who has the responsibility
                        and
                ...
                <article id="lt">
                    ...
                    <p>This procedure establishes this company&#39;s requirements for the lockout of energy isolating
                        ...
                        <strong>{{ $store->name }}</strong> where employees must deal with lockout/tagout
                    ...
                    <p>Authorized employees subject to the requirements of this program and to be trained on their
                        ...
                        supervisory personnel only, no hourly employees from <strong>{{ $store->name }}</strong>
                ...
                <article id="esp">
                    ...
                    <p>The purpose of this program is to inform interested persons, including employees, that
                        <strong>{{ $store->name }}</strong> is complying with the OSHA Electrical Safety Standard,
                        ...
                        operations at <strong>{{ $store->name }}</strong> where employees may be exposed to live
                        parts and/or those parts
                        that have been deenergized.</p>
                    <p><strong>{{ $qi }}</strong> has overall responsibility for coordinating safety and health programs
                        in
                    ...
                    <p>Every employee at <strong>{{ $store->name }}</strong> who faces the risk of electric shock
                    ...
                    <p><strong>{{ $store->name }}</strong> conducts the electrical safety training for all
                    ...
                    <p>It is a <strong>{{ $store->name }}</strong> policy that circuits and equipment must be
                ...
                <article id="swpp">
                    ...
                    <h2>Administrative Duties</h2>
                    <p><strong>{{ $sm }}</strong>, is responsible for our written stormwater pollution prevention plan.
                    ...
                    <p><strong>{{ $store->name }}</strong> has no significant materials that have been treated,
                ...
                <article id="uomp">
                    ...
                    <p>This plan provides one source of written documentation for used oil records for
                        <strong>{{ $store->name }}</strong>. In addition, this plan will inform interested
                    ...
                    <ul>
                        <li>The used oil management standards define a used oil transporter as any person who transports
                            ...
                            <strong>{{ $store->name }}</strong> utilizes a waste transport company for hauling our
                ...
                <article id="rpp">
                    ...
                    <p>This respirator program lays out standard operating procedures to ensure the protection of all
                        ...
                        1910.134.</p>
                    <h2>Administrative Duties</h2>
                    <p>At <strong>{{ $store->name }}</strong> our Respiratory Protection Program Administrator is
                    ...
                    <p>Employees may review a copy of our Respiratory Protection Program. It is located in the
                        ...
                        <strong>{{ $qi }}</strong>, reviews this program periodically to ensure its effectiveness.</p>
                    ...
                    <p>At <strong>{{ $store->name }}</strong>, persons will not be assigned to tasks requiring use
                    ...
                    <p>At <strong>{{ $store->name }}</strong>, program evaluation is performed annually by our
                ...
                <article id="bpp">
                    ...
                    <h2>Administrative Duties</h2>
                    <p><strong>{{ $qi }}</strong>, is responsible for the implementation of the ECP and is responsible
                        for maintaining, reviewing, and updating the ECP at least annually. <strong>{{ $qi }}</strong>
                    ...
                    <p>Covered employees receive an explanation of this ECP during their initial training, and annually.
                        ...
                        <strong>{{ $qi }}</strong>. The plan indicates which devices have been identified as candidates
                        for our use. <strong>{{ $qi }}</strong> solicits input from non-managerial employees responsible
                        for direct patient care in the identification, evaluation, and selection of effective
                        engineering and work practice controls. <strong>{{ $qi }}</strong> documents all solicitation in
                    ...
                    <p>The plan indicates which specific engineering controls and work practice controls are used. The
                        ...
                        for new procedures or new products. <strong>{{ $qi }}</strong> is responsible for the effective
                    ...
                    <p>Our plan indicates the steps taken to effectively contain regulated wastes, including sharps,
                        during handling.</p>
                    <p><i>Labels</i></p>
                    <p>The plan indicates which labeling method(s) is used in this facility. <strong>{{ $sm }}</strong>,
                        ensures that proper, effective labeling is used. The local health department and
                        <strong>{{ $store->name }}</strong> provides training to employees on hepatitis B
                    ...
                    <p><strong>{{ $qi }}</strong> ensures that the responsible health care professional(s) is given a
                    ...
                    <p>Training records are kept for at least three years at <strong>{{ $qi }}</strong> office location.
                    ...
                    <p>If an exposure incident occurs, it is evaluated, and <strong>{{ $qi }}</strong> determines if the
                ...
                <article id="ppe">
                    ...
                    <p>While OSHA's Personal Protective Equipment regulation, found at 29 CFR 1910.132-.140 (Subpart I),
                        ...
                        <strong>{{ $store->name }}</strong> has developed a written PPE program to document and
                        specify all information relative to our PPE needs.</p>
                    <p>The <strong>{{ $sm }}</strong>, is the program coordinator, acting as the representative of the
                ...
                <article id="cgp">
                    ...
                    <h2>Purpose</h2>
                    <p>It is the policy of <strong>{{ $store->name }}</strong> to permit only trained and
                ...
                <article id="fpp">
                    ...
                    <p><strong>{{ $qi }}</strong>, is the Plan Coordinator, acting as the representative of the Facility
                        ...
                        Individual’s office and or online compliance dashboard. <strong>{{ $qi }}</strong>, will review
                        and
                    ...
                    <p>Here at <strong>{{ $store->name }}</strong>, the Plan Coordinator,
                ...
                <article id="mesg">
                    ...
                    <p>This written Machine/Equipment Safety and Guarding Plan describes methods and practices for
                        ...
                        managers, supervisors, and employees at {{ $store->name }}. This written plan is intended to be
                        used
                        to:</p>
                    <ul>
                        ...
                        <li>Demonstrate <strong>{{ $store->name }}&#39;s</strong> compliance with machine safety
                            and equipment usage
                    ...
                    <p><strong>{{ $qi }}</strong> will identify all new employees in the employee Orientation Program
                        and
                    ...
                    <p>Although we may not be able to eliminate all problems, we try to eliminate as many as possible
                        ...
                        <strong>{{ $sm }}</strong>, is responsible for evaluating and updating this written plan. The
                        evaluation will
