<div class="p-6">
    ...
    <form wire:submit.prevent="create" class="prose min-w-full">
        ...
        <div>
            ...
            <p>Dated this {{ now()->format('jS') }} day of {{ now()->format('F') }}, {{ now()->format('Y') }}.</p>
            <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
                <div class="p-3 rounded-md">
                    <x-text-input placeholder="Type your name" wire:model.defer="adoption_approval_name_one" id="title" class="block mb-1 w-[302px] shadow-none" type="text"
                                  name="title"
                                  :value="old('title')"/>
                    <x-signature-pad wire:model.defer="adoption_approval_signature_one"/>
                </div>
                <div class="p-3 rounded-md">
                    <x-text-input placeholder="Type your name" wire:model.defer="adoption_approval_name_two" id="title" class="block mb-1 w-[302px] shadow-none" type="text"
                                  name="title"
                                  :value="old('title')"/>
                    <x-signature-pad wire:model.defer="adoption_approval_signature_two"/>
                </div>
                <div class="p-3 rounded-md">
                    <x-text-input placeholder="Type your name" wire:model.defer="adoption_approval_name_three" id="title" class="block mb-1 w-[302px] shadow-none" type="text"
                                  name="title"
                                  :value="old('title')"/>
                    <x-signature-pad wire:model.defer="adoption_approval_signature_three"/>
                </div>
            </div>
        </div>
        ...
        <div>
            ...
            @if($standard_dpp_rate) {{ $standard_dpp_rate[0] }} @else <span class="text-red-500 font-black">A Standard DPP Rate is required to complete the CMS Manual</span> @endif.</p>
            ...
            <p>Adopted and approved by the Board of Directors for {{ tenant('name') }} this {{ now()->format('jS') }} day of {{ now()->format('F') }}, {{ now()->format('Y') }}</p>
            <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
                <div class="p-3 rounded-md">
                    <x-text-input placeholder="Type your name" wire:model.defer="dealer_participation_name" id="title" class="block mb-1 w-[302px] shadow-none" type="text"
                                  name="title"
                                  :value="old('title')" />
                    <x-signature-pad wire:model.defer="dealer_participation_signature"/>
                </div>
            </div>
        </div>
                ...
                <div class="grid grid-cols-4 gap-5">
                    ...
                    <div class="col-span-2 flex items-end">
                        ...
                        <div class="relative w-auto">
                            <label>
                                <input disabled placeholder="{{ $standard_dpp_rate }}" type="text" class="peer block w-full border-0 py-0 sm:text-sm">
                            </label>
                            <div class="absolute inset-x-0 bottom-0 border-t border-gray-300 peer-focus:border-t-2" aria-hidden="true"></div>
                        </div>
                    </div>
        ...
        <div>
            ...
            @if($qi)
                <p class="text-red-500 font-black">{{ $qi }}</p>
            @else
                <p class="text-red-500 font-black">A Qualified Individual is required to complete the CMS Manual</p>
            @endif
        ...
        <div>
            ...
            <p>Dated: {{ now()->format('F d, Y') }}</p>
            <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
                <div class="p-3 rounded-md">
                    <x-text-input
                        placeholder="Type your name"
                        wire:model.defer="acknowledgement_name"
                        id="title"
                        class="block mb-1 w-[302px] shadow-none"
                        type="text"
                        name="title"
                        :value="old('title')"
                        required
                    />
                    <x-signature-pad required wire:model.defer="acknowledgement_signature"/>
                    @error('acknowledgement_signature') <span class="text-red-500 font-black">{{ $message }}</span> @enderror
                </div>
            </div>
        </div>
        <button
            ...
            @if(!$standard_dpp_rate || !$qi) disabled @endif
        >
