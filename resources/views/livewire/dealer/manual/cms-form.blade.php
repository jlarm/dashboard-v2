        ...
        <div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
                <div class="p-3 rounded-md">
                    <x-text-input placeholder="Type your name" wire:model.defer="title" id="title" class="block mb-1 w-[302px] shadow-none" type="text"
                                  name="title"
...
{{--        Dealer Participation Program--}}
        <div>
            ...
            <p>1. An up-to-date fair lending policy statement approved by management setting a standard markup for non-subvented loans, and establishing exceptions to the standard markup based solely on legitimate business needs.  Dealership has adopted a policy of a dealer participation rate of {{ $standard_dpp_rate }}.</p>
...
{{--        Appointment and Program Approval--}}
        <div>
            ...
            @if($qi)
                <p class="text-red-500 font-black">{{ $qi->name }}</p>
            @else
