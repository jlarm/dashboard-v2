    ...
    <div class="relative md:flex">
        <div class="w-full md:w-64 md:fixed inset-y-0 z-10 flex flex-col pr-6 md:mt-32 md:border-r">
            <ul class="toc mt-3 space-y-3 text-sm text-gray-500">
                ...
                <li>
                    <a href="#objectives" class="hover:text-arm-orange-600 transition">ISP Objectives</a>
                </li>
                <li>
                    <a href="#handling" class="hover:text-arm-orange-600 transition">Handling and Processing Customer NPI</a>
                </li>
                <li>
                    <a href="#incident" class="hover:text-arm-orange-600 transition">Incident Response Plan</a>
                </li>
                <li>
                    <a href="#breach" class="hover:text-arm-orange-600 transition">Data Breach Guidelines</a>
                </li>
                <li>
                    <a href="#storage" class="hover:text-arm-orange-600 transition">Information Storage IT Safeguards Cyber Security</a>
                </li>
                <li>
                    <a href="#disposal" class="hover:text-arm-orange-600 transition">Disposal of Consumer Information and Records</a>
                </li>
                <li>
                    <a href="#processing" class="hover:text-arm-orange-600 transition">Processing Customer NPI by Department</a>
                </li>
                <li>
                ...
                <li>
                    <a href="#body">- Body Shop</a>
                </li>
                <li>
                    <a href="#personnel">Dealership Personnel</a>
                </li>
                <li>
                    <a href="#third">Third Party Providers</a>
                </li>
                <li>
                    <a href="#records">Record Retention List</a>
                </li>
                <li>
                    <a href="#form">Signature</a>
                </li>
            </ul>
        </div>
        <div class="md:pl-72 relative top-2 divide-y mb-10 prose min-w-full">
            <!-- Contacts -->
            <div class="text-sm">
                <div class="grid grid-cols-2 md:grid-cols-3 gap-3">
                    <div>
                        <p class="font-bold m-0">Qualified Individual</p>
                        <p class="m-0">{{ $qi }}</p>
                        <p class="m-0">{{ $qip }}</p>
                    </div>
                    <div>
                        <p class="font-bold m-0">Owner</p>
                        <p class="m-0">{{ $owner }}</p>
                        <p class="m-0">{{ $ownerp }}</p>
                    </div>
                    <div>
                        <p class="font-bold m-0">General Manager</p>
                        <p class="m-0">{{ $gm }}</p>
                        <p class="m-0">{{ $gmp }}</p>
                    </div>
                    <div>
                        <p class="font-bold m-0">Service Manager</p>
                        <p class="m-0">{{ $sm }}</p>
                        <p class="m-0">{{ $smp }}</p>
                    </div>
                    <div>
                        <p class="font-bold m-0">Parts Manager</p>
                        <p class="m-0">{{ $pm }}</p>
                        <p class="m-0">{{ $pmp }}</p>
                    </div>
                    <div>
                        <p class="font-bold m-0">Body Shop Manager</p>
                        <p class="m-0">{{ $bsm }}</p>
                        <p class="m-0">{{ $bsmp }}</p>
                    </div>
                </div>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5 py-10">
                    <div class="space-y-5">
                        <div>
                            <p class="font-bold m-0">Police Emergency Phone Number</p>
                            <p class="m-0">{{ $pepn }}</p>
                        </div>
                        <div>
                            <p class="font-bold m-0">Police Non-Emergency Phone Number</p>
                            <p class="m-0">{{ $pnepn}}</p>
                        </div>
                    </div>
                    <div class="space-y-5">
                        <div>
                            <p class="font-bold m-0">Fire Emergency Phone Number</p>
                            <p class="m-0">{{ $fepn }}</p>
                        </div>
                        <div>
                            <p class="font-bold m-0">Fire Non-Emergency Phone Number</p>
                            <p class="m-0">{{ $fnepn }}</p>
                        </div>
                    </div>
                </div>
            ...
            <!-- Contacts -->
            <!-- 8 Elements Dealerships Must Comply With -->
            <div class="pt-16" id="elements">
                <h1>
            ...
            <!-- Data Breach Guidelines -->
            <!-- Information Storage IT Safeguards Cyber Security -->
            <div class="pt-16" id="storage">
        ...
        window.addEventListener('DOMContentLoaded', () => {
            ...
            const removeActiveClasses = () => {
                tocLinks.forEach(link => {
                    link.classList.remove('text-arm-orange-500');
                });
            };
            ...
            const observerCallback = (entries) => {
                entries.forEach(entry => {
                    ...
                    if (entry.isIntersecting) {
                        removeActiveClasses();
                        if (tocLink) {
                            tocLink.classList.add('text-arm-orange-500');
                        }
                    }
                });
            };
