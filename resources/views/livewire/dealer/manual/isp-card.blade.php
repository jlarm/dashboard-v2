                    ...
                    <div class="flex items-end space-x-4">
                        @if($isp)
                            <div class="min-w-0 flex-1">
                                ...
                                <p class="truncate text-sm text-gray-800">{{ $isp->created_at->format('F d, Y') }}</p>
                            </div>
                        @else
                            <div class="min-w-0 flex-1">
                                <a href="@if(!tenant('locations')) {{ route('dealer.manual.isp') }} @else {{ route('dealer.stores.manuals.isp', $store) }} @endif"
