<div x-data="{
    ...
    <div>
        ...
        <form wire:submit.prevent="edit" class="space-y-5 px-5 md:px-0 text-sm">
            ...
            <div class="space-y-5" >
                ...
                @empty
                    <button
                        onclick="Livewire.emit('modal.open', 'dealer.audit.finance.modal'); setTimeout(() => { document.querySelector('[wire\\:model=search]').focus(); }, 300);"
                        type="button"
    ...
    <div class="fixed bottom-5 right-5">
        <button class="inline-flex h-14 w-14 items-center justify-center rounded-full bg-arm-blue-500" onclick="Livewire.emit('modal.open', 'dealer.audit.finance.modal'); setTimeout(() => { document.querySelector('[wire\\:model=search]').focus(); }, 300);">
