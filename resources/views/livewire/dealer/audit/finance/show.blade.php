    ...
    <form class="md:px-4" wire:loading.class="opacity-25">
        <div class="space-y-5">
                ...
                <div class="bg-gray-50 p-3 space-y-7">
                        ...
                        <fieldset class="mt-4">
                            <div class="flex items-center space-x-5">
                                <div class="flex items-center">
                                    <input
                                        wire:model.defer="finance_q{{ $question->id }}_answer"
                                        value="1"
                                        name="finance_q{{ $question->id }}_answer"
                                        id="finance_q{{ $question->id }}_answer_1"
                                        type="radio"
                                        class="h-4 w-4 border-gray-300 text-arm-blue-600 focus:ring-arm-blue-600"
                                    >
                                    <label for="finance_q{{ $question->id }}_answer_1"
                                ...
                                <div class="flex items-center">
                                    <input
                                        ...
                                        value="2"
                                        name="finance_q{{ $question->id }}_answer"
                                        id="finance_q{{ $question->id }}_answer_2"
                                        type="radio"
                                        class="h-4 w-4 border-gray-300 text-arm-blue-600 focus:ring-arm-blue-600"
                                    >
                                    <label for="finance_q{{ $question->id }}_answer_2"
                                ...
                                <div class="flex items-center">
                                    <input
                                        ...
                                        value="3"
                                        name="finance_q{{ $question->id }}_answer"
                                        id="finance_q{{ $question->id }}_answer_3"
                                        type="radio"
                                        class="h-4 w-4 border-gray-300 text-arm-blue-600 focus:ring-arm-blue-600"
                                    >
                                    <label for="finance_q{{ $question->id }}_answer_3"
                    ...
                    <div class="relative flex items-start">
                        <div class="flex h-6 items-center">
                            <label>
                                <input
                                    wire:model.defer="finance_q{{ $question->id }}_danger"
                                    id="finance_q{{ $question->id }}_danger"
                                    type="checkbox"
                        ...
                        <div class="ml-3 text-sm leading-6">
                            <label for="finance_q{{ $question->id }}_danger" class="font-medium text-red-500">Flag as
                                high
                                risk</label>
                        </div>
                    </div>
                    <div>
                        ...
                        <textarea wire:model.defer="finance_q{{ $question->id }}_comment"
                                  id="finance_q{{ $question->id }}_comment" name="finance_q{{ $question->id }}_comment"
                                  rows="3"
                    ...
                    <x-media-library-collection
                        ...
                        name="finance_q{{ $question->id }}_images"
                        :model="$financeAudit"
                        collection="finance_q{{ $question->id }}_images"
                    />
                </div>
            @endforeach
            ...
            <div class="bg-gray-50 p-3 space-y-3">
                <div>
                    <label class="text-base font-semibold text-gray-900">Please note any additional issue/violation
                        found
