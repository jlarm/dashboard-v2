...
>
    <div>
        ...
        <form wire:submit.prevent="edit" class="space-y-5 px-5 md:px-0 text-sm">
            ...
            <div class="space-y-5" >
                ...
                @empty
                    <button
                        onclick="Livewire.emit('modal.open', 'dealer.audit.body-shop.modal', @js(['auditId' => $bodyShopViolationAudit->id, 'auditType' => get_class($bodyShopViolationAudit)]))"
                        type="button"
            ...
            <div class="flex space-x-2 items-center justify-between">
                <div>
                    ...
                    @endif
                    <x-button.secondary href="{{ tenant('locations') ? route('dealer.stores.audits.body-shop.index', $store) : route('dealer.audit.body-shop.index') }}">Exit</x-button.secondary>
                </div>
                <div>
    ...
    <div class="fixed bottom-5 right-5">
        <button class="inline-flex h-14 w-14 items-center justify-center rounded-full bg-arm-blue-500" onclick="Livewire.emit('modal.open', 'dealer.audit.body-shop.modal', @js(['auditId' => $bodyShopViolationAudit->id, 'auditType' => get_class($bodyShopViolationAudit)]))">
