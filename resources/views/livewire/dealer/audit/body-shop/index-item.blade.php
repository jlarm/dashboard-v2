    ...
    <div class="space-y-1">
        <div class="flex justify-between">
            ...
            >
                ...
                >
                    ...
                    @endcan
                    <a href="{{ tenant('locations') ? route('dealer.stores.audits.body-shop.view', [$store, $bodyShopAudit->uuid]) : route('dealer.audit.body-shop.show', $bodyShopAudit->uuid) }}" class="flex items-center gap-2 px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 hover:text-gray-900">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="16" height="16" color="#4a4a4a" fill="none">
        ...
        <span class="text-xs text-gray-600">
          Total Violations:
            ...
            <span class="text-sm font-medium text-gray-800">
           {{ $bodyShopAudit->violations->count() }}
        </span>
        </div>
        <!-- End Item -->
