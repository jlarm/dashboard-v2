                    ...
                    >
                        ...
                        <div class="space-y-4 p-6">
                            ...
                            <div class="space-y-1 pt-2">
                                ...
                                @can('create-audits')
                                    <a href="{{ route('dealer.audit.osha.edit', $oshaAudit->uuid) }}" class="group flex items-center gap-3 rounded-md px-3 py-2.5 text-sm font-medium text-gray-700 hover:bg-gray-100 hover:text-gray-900">
                                ...
                                @if($this->remediationsActive() && $oshaAudit->completed_date)
                                    @can('view-audits')
                                        <a href="{{ route('dealer.audit.osha.remediation', $oshaAudit->uuid) }}" class="group flex items-center gap-3 rounded-md px-3 py-2.5 text-sm font-medium text-gray-700 hover:bg-gray-100 hover:text-gray-900">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="18" height="18" class="text-gray-400 group-hover:text-gray-500" fill="none">
