            ...
            @foreach($questions as $question)
                <div class="bg-gray-50 p-3 space-y-7">
                    <div>
                            ...
                            <fieldset class="mt-4">
                                <div class="flex items-center space-x-5">
                                    <div class="flex items-center">
                                        <input
                                            wire:model.defer="osha_q{{ $question->id }}_answer"
                                            value="1"
                                            name="osha_q{{ $question->id }}_answer"
                                            id="osha_q{{ $question->id }}_answer_1"
                                            type="radio"
                                            class="h-4 w-4 border-gray-300 text-arm-blue-600 focus:ring-arm-blue-600"
                                        >
                                        <label for="osha_q{{ $question->id }}_answer_1"
                                    ...
                                    <div class="flex items-center">
                                        <input
                                            ...
                                            value="2"
                                            name="osha_q{{ $question->id }}_answer"
                                            id="osha_q{{ $question->id }}_answer_2"
                                            type="radio"
                                            class="h-4 w-4 border-gray-300 text-arm-blue-600 focus:ring-arm-blue-600"
                                        >
                                        <label for="osha_q{{ $question->id }}_answer_2"
                                    ...
                                    <div class="flex items-center">
                                        <input
                                            ...
                                            value="3"
                                            name="osha_q{{ $question->id }}_answer"
                                            id="osha_q{{ $question->id }}_answer_3"
                                            type="radio"
                                            class="h-4 w-4 border-gray-300 text-arm-blue-600 focus:ring-arm-blue-600"
                                        >
                                        <label for="osha_q{{ $question->id }}_answer_3"
                        ...
                        @else
                            <input
                                wire:model.defer="osha_q{{ $question->id }}_date"
                                type="date"
                                name="osha_q{{ $question->id }}_date"
                                id="osha_q{{ $question->id }}_date"
                                pattern=""
                    ...
                    <div class="relative flex items-start">
                        <div class="flex h-6 items-center">
                            <label>
                                <input
                                    wire:model.defer="osha_q{{ $question->id }}_danger"
                                    id="osha_q{{ $question->id }}_danger"
                                    type="checkbox"
                        ...
                        <div class="ml-3 text-sm leading-6">
                            <label for="osha_q{{ $question->id }}_danger" class="font-medium text-red-500">Flag as high
                                risk</label>
                        </div>
                    </div>
                    <div>
                        <label class="text-base font-semibold text-gray-900">Comments</label>
                        <textarea wire:model.defer="osha_q{{ $question->id }}_comment"
                                  id="osha_q{{ $question->id }}_comment" name="osha_q{{ $question->id }}_comment"
                                  rows="3"
                    ...
                    <x-media-library-collection
                        ...
                        name="osha_q{{ $question->id }}_images"
                        :model="$oshaAudit"
                        collection="osha_q{{ $question->id }}_images"
                    />
                </div>
            @endforeach
        </div>
