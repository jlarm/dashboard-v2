<div class="grid grid-cols-1 md:grid-cols-3 md:gap-10">
    <div
        @class([
        'mb-5 md:mb-0',
        'col-span-2' => count($reports) > 0,
        'col-span-3 text-center' => count($reports) == 0,
        ])
    >
                                    ...
                                    <div class="flex gap-5">
                                        @foreach($report as $r)
                                            @if($r->type === 'executive')
                                                ...
                                                >
                                                    <svg class="flex-shrink-0 size-4 mr-1" width="400" height="492" viewBox="0 0 400 492" fill="none" xmlns="http://www.w3.org/2000/svg">
