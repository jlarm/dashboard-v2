<x-wire-elements-pro::tailwind.modal on-submit="deleteInvite" :content-padding="true">
    <x-slot name="title">Delete Invite</x-slot>

    Do you really want to delete this invite for {{ $invite->name }}?
