<div>
    ...
    <div
        ...
        <div class="fixed inset-0 z-40 flex">
            <div
                ...
                class="relative flex w-full max-w-xs flex-1 flex-col bg-arm-blue-900 pt-5 pb-4">
                        ...
                        <div class="space-y-1">
                            ...
                            @can('create-stores')
                                @if(app('multipleStoresExist'))
                                    <a
                                        href="{{ route('dealer.locations.index') }}"
                                        class="{{ request()->is('locations') ? 'bg-arm-blue-50 text-arm-blue-600 border-arm-blue-600' : 'text-gray-600 hover:text-gray-900 hover:bg-gray-50' }} border-transparent group border-l-4 py-2 px-3 flex items-center text-sm font-medium"
                                    >
                                        <svg
                                            class="{{ request()->is('locations') ? 'text-arm-blue-500' : 'text-gray-400 group-hover:text-gray-500' }} mr-3 flex-shrink-0 h-6 w-6"
                                            xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                            stroke-width="1.5"
                                            stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round"
                            ...
                            @if(!app('multipleStoresExist'))
                                @can('view-manuals')
                                    <a
                                        href="{{ route('dealer.doc.index') }}"
                                        class="{{ (request()->segment(1) == 'docs') ? 'bg-arm-blue-50 text-arm-blue-600 border-arm-blue-600' : 'text-gray-600 hover:text-gray-900 hover:bg-gray-50' }} border-transparent group border-l-4 py-2 px-3 flex items-center text-sm font-medium"
                                    >
                                        <svg
                                            ...
                                            stroke-width="1.5"
                                            stroke="currentColor"
                                            class="{{ (request()->segment(1) == 'docs') ? 'text-arm-blue-500' : 'text-gray-400 group-hover:text-gray-500' }} mr-3 flex-shrink-0 h-6 w-6"
                                        >
                                            <path stroke-linecap="round" stroke-linejoin="round"
                                                  d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m0 12.75h7.5m-7.5 3H12M10.5 2.25H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 00-9-9z"/>
                                        </svg>
    ...
    <div class="hidden lg:fixed md:inset-y-0 lg:flex md:w-64 md:flex-col">
        ...
        <nav class="flex flex-grow flex-col overflow-y-auto border-r border-gray-200 bg-arm-blue-900 pt-5 pb-4">
            <div class="flex flex-shrink-0 items-center px-4">
                <x-application-white-icon class="h-8 fill-white"/>
            </div>
            <div class="mt-5 flex-grow">
                <div class="space-y-1">
                    ...
                    <a
                        href="{{ route('dealer.dashboard') }}"
                        class="{{ (request()->is('dashboard')) ? 'bg-arm-blue-500 border-arm-blue-600' : '' }} text-white border-transparent group border-l-4 py-2 px-3 flex items-center text-sm font-medium"
                    >
                        <svg
                            class="{{ request()->is('dashboard') ? 'text-white' : 'text-white group-hover:text-gray-500' }} mr-3 flex-shrink-0 h-6 w-6"
                    ...
                    @if(app('multipleStoresExist'))
                        @can('create-stores')
                            <a
                                href="{{ route('dealer.locations.index') }}"
                                class="{{ (request()->segment(1) == 'locations') ? 'bg-arm-blue-50 text-arm-blue-600 border-arm-blue-600' : 'text-gray-600 hover:text-gray-900 hover:bg-gray-50' }} border-transparent group border-l-4 py-2 px-3 flex items-center text-sm font-medium"
                            >
                                <svg
                                    class="{{ (request()->segment(1) == 'locations') ? 'text-arm-blue-500' : 'text-gray-400 group-hover:text-gray-500' }} mr-3 flex-shrink-0 h-6 w-6"
                                    xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="1.5"
                                    stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <a href="https://docs.armp.app/" target="_blank"
                       class="group flex items-center border-l-4 border-transparent py-2 px-3 text-sm font-medium text-gray-600 hover:bg-gray-50 hover:text-gray-900">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                             stroke="currentColor" class="mr-3 h-6 w-6 text-gray-400 group-hover:text-gray-500">
                            <path stroke-linecap="round" stroke-linejoin="round"
