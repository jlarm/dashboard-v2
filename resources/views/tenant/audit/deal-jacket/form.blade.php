<x-dealer-app>
    ...
    <x-slot:actions>
        <x-button :href="tenant('locations') ? route('dealer.stores.audits.deal-jackets.show', [$store, $dealJacketGroup]) : route('dealer.audit.deal-jackets.show', $dealJacketGroup)" variant="ghost">
            <x-slot:icon>
