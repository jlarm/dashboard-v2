    ...
    <div
        ...
        <div class="mt-4 flex space-x-5 sm:mt-0 sm:ml-4">
            @if($stores)
                ...
                @can('create-stores')
                    <a class="inline-flex items-center px-4 py-2 bg-white border border-gray-300 rounded-md font-semibold text-xs text-gray-700 uppercase tracking-widest shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-arm-blue-500 focus:ring-offset-2 disabled:opacity-25 transition ease-in-out duration-150" href="{{ route('dealer.deleted.index') }}">Deleted</a>
                @endcan
            @endif
        </div>
    </div>
