@extends('dealer.manual.pdf._layout', [
    'dealershipName' => $isp->store->name,
    'manualTitle' => 'Information Security Program',
])
...
<div class="cover">
    ...
    <h1 class="cover__dealership">{{ $isp->store->name }}</h1>
    <p class="cover__title">Information Security Program</p>
    <div class="cover__meta">
        <div class="cover__meta-date">Effective Date</div>
        <div>{{ $isp->created_at->format('F j, Y') }}</div>
        <div style="margin-top: 0.12in;">
            {{ $isp->store->address }}<br>
            {{ $isp->store->city }}, {{ $isp->store->state }} {{ $isp->store->postal_code }}<br>
...
<div class="page-break">
    <div class="personnel">
        ...
        <table class="data">
            ...
            <tbody>
                <tr><td><span class="name">{{ $isp->owner_name }}</span><span class="role">Owner</span></td><td>{{ $isp->owner_phone }}</td></tr>
                <tr><td><span class="name">{{ $isp->general_manager_name }}</span><span class="role">General Manager</span></td><td>{{ $isp->general_manager_phone }}</td></tr>
                <tr><td><span class="name">{{ $isp->body_shop_manager_name }}</span><span class="role">Body Shop Manager</span></td><td>{{ $isp->body_shop_manager_phone }}</td></tr>
                <tr><td><span class="name">{{ $isp->parts_manager_name }}</span><span class="role">Parts Manager</span></td><td>{{ $isp->parts_manager_phone }}</td></tr>
                <tr><td><span class="name">{{ $isp->service_manager_name }}</span><span class="role">Service Manager</span></td><td>{{ $isp->service_manager_phone }}</td></tr>
                <tr><td><span class="name">{{ $isp->qualified_individual_name }}</span><span class="role">Qualified Individual</span></td><td>{{ $isp->qualified_individual_phone }}</td></tr>
            </tbody>
        </table>
    </div>
