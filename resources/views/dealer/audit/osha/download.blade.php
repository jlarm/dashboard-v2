...
<div class="max-w-4xl mx-auto">
    ...
    <ul class="divide-y divide-gray-300">
        ...
        @if($oshaAudit->osha_q54_answer === 2 || $oshaAudit->osha_q54_answer === 3)
            <li class="py-10 space-y-5 page-break">
                <div>
                    <p class="font-bold">Are any electrical cords frayed, cracked, taped, or spliced or ground missing
                        on 3
                        prong plugs?</p>
                    <p>
            ...
            <li class="py-10 space-y-5 page-break">
                <div>
                    <p class="font-bold">Is the first aid kit identified and is it stocked with appropriate supplies?
                        ...
                        gloves, sterile pads, triangular bandages. Recommend that the first aid kits be mounted and
                        visible
                    ...
                    <div class="rounded-md bg-yellow-50 p-4">
                        <div class="flex">
                            ...
                            <div class="ml-3">
                                <h3 class="text-sm font-medium text-yellow-800">Attention needed</h3>
                                <div class="mt-2 text-sm text-yellow-700">
                                    <p>OSHA and the NEC both mandate a minimum clearance of 36 inches on panels of less
                                        than
