...
<div class="max-w-4xl mx-auto">
    ...
    <ul class="divide-y divide-gray-300">
        ...
        <li class="py-10 space-y-5 page-break">
            ...
            @endif
            @if($oshaAudit->osha_q1_answer === 2 || $oshaAudit->osha_q1_answer === 3)
        ...
        <li class="py-10 space-y-5 page-break">
            ...
            @endif
            @if($oshaAudit->osha_q2_answer === 2 || $oshaAudit->osha_q2_answer === 3)
                <div class="rounded-md bg-yellow-50 p-4">
                    <div class="flex">
                        <div class="flex-shrink-0">
                            <svg class="h-5 w-5 text-yellow-400" viewBox="0 0 20 20" fill="currentColor"
                        ...
                        <div class="ml-3">
                            ...
                            <div class="mt-2 text-sm text-yellow-700">
                                <p>Federal Code of Regulations 40
                                    <a href="https://www.ecfr.gov/current/title-40/chapter-I/subchapter-I/part-266/subpart-G">CFR
                                        part 273. Subpart G - Spent
                                        Lead-Acid Batteries Being
                                        Reclaimed</a>
                                    <a href="https://www.ecfr.gov/current/title-40/chapter-I/subchapter-I/part-266/subpart-G/section-266.80">§
                                        266.80 Applicability and
                                        requirements.</a></p>
                            </div>
                        </div>
                    </div>
        ...
        <li class="py-10 space-y-5 page-break">
            ...
            @endif
            @if($oshaAudit->osha_q3_answer === 2 || $oshaAudit->osha_q3_answer === 3)
                <div class="rounded-md bg-yellow-50 p-4">
                    <div class="flex">
                        <div class="flex-shrink-0">
                            <svg class="h-5 w-5 text-yellow-400" viewBox="0 0 20 20" fill="currentColor"
        ...
        <li class="py-10 space-y-5 page-break">
            ...
            @endif
            @if($oshaAudit->osha_q4_answer === 2 || $oshaAudit->osha_q4_answer === 3)
                <div class="rounded-md bg-yellow-50 p-4">
                    <div class="flex">
                        <div class="flex-shrink-0">
                            <svg class="h-5 w-5 text-yellow-400" viewBox="0 0 20 20" fill="currentColor"
                        ...
                        <div class="ml-3">
                            <h3 class="text-sm font-medium text-yellow-800">Attention needed</h3>
                            <div class="mt-2 text-sm text-yellow-700">
                                <p><a href="https://www.osha.gov/laws-regs/regulations/standardnumber/1910/1910.178">29
                                        CFR 1910.178(l)(2)(ii) –
        ...
        <li class="py-10 space-y-5 page-break">
            <div>
                <p class="font-bold">Review OSHA 300 &amp; was OSHA
                    300A
                    - Annual Summary posted and uploaded.</p>
                <p>
            ...
            @endif
            @if($oshaAudit->osha_q5_answer === 2 || $oshaAudit->osha_q5_answer === 3)
                <div class="rounded-md bg-yellow-50 p-4">
                    <div class="flex">
                        <div class="flex-shrink-0">
                            <svg class="h-5 w-5 text-yellow-400" viewBox="0 0 20 20" fill="currentColor"
        ...
        <li class="py-10 space-y-5 page-break">
            ...
            @endif
            {{--            @if($oshaAudit->osha_q6_answer === 2 || $oshaAudit->osha_q6_answer === 3)--}}
            {{--                <div class="rounded-md bg-yellow-50 p-4">--}}
            {{--                    <div class="flex">--}}
            {{--                        <div class="flex-shrink-0">--}}
            {{--                            <svg class="h-5 w-5 text-yellow-400" viewBox="0 0 20 20" fill="currentColor"--}}
        ...
        <li class="py-10 space-y-5 page-break">
            <div>
                <p class="font-bold">Hybrid - Handling of “High-Voltage Batteries”</p>
                <p>
            ...
            @endif
            {{--            @if($oshaAudit->osha_q7_answer === 2 || $oshaAudit->osha_q7_answer === 3)--}}
            {{--                <div class="rounded-md bg-yellow-50 p-4">--}}
            {{--                    <div class="flex">--}}
            {{--                        <div class="flex-shrink-0">--}}
            {{--                            <svg class="h-5 w-5 text-yellow-400" viewBox="0 0 20 20" fill="currentColor"--}}
        ...
        <li class="py-10 space-y-5 page-break">
            ...
            @endif
            @if($oshaAudit->osha_q8_answer === 2 || $oshaAudit->osha_q8_answer === 3)
                <div class="rounded-md bg-yellow-50 p-4">
                    <div class="flex">
                        <div class="flex-shrink-0">
                            <svg class="h-5 w-5 text-yellow-400" viewBox="0 0 20 20" fill="currentColor"
        ...
        <li class="py-10 space-y-5 page-break">
            <div>
                <p class="font-bold">Any other State or Local EPA filings
                    to upload</p>
                <p>
            ...
            @endif
            {{--            @if($oshaAudit->osha_q9_answer === 2 || $oshaAudit->osha_q9_answer === 3)--}}
            {{--                <div class="rounded-md bg-yellow-50 p-4">--}}
            {{--                    <div class="flex">--}}
            {{--                        <div class="flex-shrink-0">--}}
            {{--                            <svg class="h-5 w-5 text-yellow-400" viewBox="0 0 20 20" fill="currentColor"--}}
        ...
        <li class="py-10 space-y-5 page-break">
            ...
            @endif
            @if($oshaAudit->osha_q10_answer === 2 || $oshaAudit->osha_q10_answer === 3)
                <div class="rounded-md bg-yellow-50 p-4">
                    <div class="flex">
                        <div class="flex-shrink-0">
                            <svg class="h-5 w-5 text-yellow-400" viewBox="0 0 20 20" fill="currentColor"
        ...
        <li class="py-10 space-y-5 page-break">
            <div>
                <p class="font-bold">Has there been any employee
                    exposed to a spill of a chemical
                    since last visit?</p>
                <p>
            ...
            @endif
            @if($oshaAudit->osha_q11_answer === 2 || $oshaAudit->osha_q11_answer === 3)
                <div class="rounded-md bg-yellow-50 p-4">
                    <div class="flex">
                        <div class="flex-shrink-0">
                            <svg class="h-5 w-5 text-yellow-400" viewBox="0 0 20 20" fill="currentColor"
        ...
        <li class="py-10 space-y-5 page-break">
            <div>
                <p class="font-bold">Are all products that are in
                    containers other than the original
                    properly labeled with product
                    NAME, MFG, and appropriate
                    hazard warning?</p>
                <p>
            ...
            @endif
            @if($oshaAudit->osha_q12_answer === 2 || $oshaAudit->osha_q12_answer === 3)
                <div class="rounded-md bg-yellow-50 p-4">
                    <div class="flex">
                        <div class="flex-shrink-0">
                            <svg class="h-5 w-5 text-yellow-400" viewBox="0 0 20 20" fill="currentColor"
        ...
        <li class="py-10 space-y-5 page-break">
            <div>
                <p class="font-bold">Have there been any accidents
                    since last visit?</p>
                <p>
            ...
            @endif
            @if($oshaAudit->osha_q13_answer === 2 || $oshaAudit->osha_q13_answer === 3)
                <div class="rounded-md bg-yellow-50 p-4">
                    <div class="flex">
                        <div class="flex-shrink-0">
                            <svg class="h-5 w-5 text-yellow-400" viewBox="0 0 20 20" fill="currentColor"
        ...
        <li class="py-10 space-y-5 page-break">
            ...
            @endif
            @if($oshaAudit->osha_q14_answer === 2 || $oshaAudit->osha_q14_answer === 3)
                <div class="rounded-md bg-yellow-50 p-4">
                    <div class="flex">
                        <div class="flex-shrink-0">
                            <svg class="h-5 w-5 text-yellow-400" viewBox="0 0 20 20" fill="currentColor"
        ...
        <li class="py-10 space-y-5 page-break">
            ...
            @endif
            @if($oshaAudit->osha_q15_answer === 2 || $oshaAudit->osha_q15_answer === 3)
                <div class="rounded-md bg-yellow-50 p-4">
                    <div class="flex">
                        <div class="flex-shrink-0">
                            <svg class="h-5 w-5 text-yellow-400" viewBox="0 0 20 20" fill="currentColor"
        ...
        <li class="py-10 space-y-5 page-break">
            <div>
                <p class="font-bold">How often is the water/solution
                    changed and documented in the
                    eye wash equipment?</p>
                <p>
            ...
            @endif
            @if($oshaAudit->osha_q16_answer === 2 || $oshaAudit->osha_q16_answer === 3)
                <div class="rounded-md bg-yellow-50 p-4">
                    <div class="flex">
                        <div class="flex-shrink-0">
                            <svg class="h-5 w-5 text-yellow-400" viewBox="0 0 20 20" fill="currentColor"
        ...
        <li class="py-10 space-y-5 page-break">
            ...
            @endif
            @if($oshaAudit->osha_q17_answer === 2 || $oshaAudit->osha_q17_answer === 3)
                <div class="rounded-md bg-yellow-50 p-4">
                    <div class="flex">
                        <div class="flex-shrink-0">
                            <svg class="h-5 w-5 text-yellow-400" viewBox="0 0 20 20" fill="currentColor"
        ...
        <li class="py-10 space-y-5 page-break">
            ...
            @endif
            @if($oshaAudit->osha_q18_answer === 2 || $oshaAudit->osha_q18_answer === 3)
                <div class="rounded-md bg-yellow-50 p-4">
                    <div class="flex">
                        <div class="flex-shrink-0">
                            <svg class="h-5 w-5 text-yellow-400" viewBox="0 0 20 20" fill="currentColor"
                        ...
                        <div class="ml-3">
                            ...
                            <div class="mt-2 text-sm text-yellow-700">
                                <p>29 CFR 1910.157(d)(2)
                                    ...
                                    Class A fires so that the travel distance for employees to any extinguisher is 75
                                    ft.</p>
                            </div>
                        </div>
                    </div>
        ...
        <li class="py-10 space-y-5 page-break">
            ...
            @endif
            @if($oshaAudit->osha_q19_answer === 2 || $oshaAudit->osha_q19_answer === 3)
                <div class="rounded-md bg-yellow-50 p-4">
                    <div class="flex">
                        <div class="flex-shrink-0">
                            <svg class="h-5 w-5 text-yellow-400" viewBox="0 0 20 20" fill="currentColor"
                        ...
                        <div class="ml-3">
                            ...
                            <div class="mt-2 text-sm text-yellow-700">
                                <p>29 CFR 1910.157(e)(3)
                                    ...
                                    examination. The employer shall record the annual maintenance date and retain this
        ...
        <li class="py-10 space-y-5 page-break">
            ...
            @endif
            @if($oshaAudit->osha_q20_answer === 2 || $oshaAudit->osha_q20_answer === 3)
                <div class="rounded-md bg-yellow-50 p-4">
                    <div class="flex">
                        <div class="flex-shrink-0">
                            <svg class="h-5 w-5 text-yellow-400" viewBox="0 0 20 20" fill="currentColor"
        ...
        <li class="py-10 space-y-5 page-break">
            <div>
                <p class="font-bold">Are Signs posted properly? </p>
                <p>
            ...
            @endif
            @if($oshaAudit->osha_q21_answer === 2 || $oshaAudit->osha_q21_answer === 3)
                <div class="rounded-md bg-yellow-50 p-4">
                    <div class="flex">
                        <div class="flex-shrink-0">
                            <svg class="h-5 w-5 text-yellow-400" viewBox="0 0 20 20" fill="currentColor"
                        ...
                        <div class="ml-3">
                            ...
                            <div class="mt-2 text-sm text-yellow-700">
                                <p>29 CFR 1910.157(d)(2) - The employer shall distribute portable fire extinguishers for
                                    use by employees on Class A fires so that the travel distance for employees to any
                                    extinguisher is 75 ft.
                                    29 CFR 1910.157©(1) - Fire extinguishers and shall mount, locate and identify them
                                    so that they are readily accessible to employees without subjecting the employees to
                                    possible injury.</p>
                            </div>
                        </div>
                    </div>
        ...
        <li class="py-10 space-y-5 page-break">
            ...
            @endif
            @if($oshaAudit->osha_q22_answer === 2 || $oshaAudit->osha_q22_answer === 3)
                <div class="rounded-md bg-yellow-50 p-4">
                    <div class="flex">
                        <div class="flex-shrink-0">
                            <svg class="h-5 w-5 text-yellow-400" viewBox="0 0 20 20" fill="currentColor"
                        ...
                        <div class="ml-3">
                            <h3 class="text-sm font-medium text-yellow-800">Attention needed</h3>
                            <div class="mt-2 text-sm text-yellow-700">
                                <p>29 CFR 1910.252 / ANSI Z49.1 Safety in Welding, Cutting, and Allied Processes.</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <li class="py-10 space-y-5 page-break">
            ...
            @endif
            @if($oshaAudit->osha_q23_answer === 2 || $oshaAudit->osha_q23_answer === 3)
                <div class="rounded-md bg-yellow-50 p-4">
                    <div class="flex">
                        <div class="flex-shrink-0">
                            <svg class="h-5 w-5 text-yellow-400" viewBox="0 0 20 20" fill="currentColor"
        ...
        <li class="py-10 space-y-5 page-break">
            ...
            @endif
            @if($oshaAudit->osha_q24_answer === 2 || $oshaAudit->osha_q24_answer === 3)
                <div class="rounded-md bg-yellow-50 p-4">
                    <div class="flex">
                        <div class="flex-shrink-0">
                            <svg class="h-5 w-5 text-yellow-400" viewBox="0 0 20 20" fill="currentColor"
        ...
        <li class="py-10 space-y-5 page-break">
            ...
            @endif
            {{--            @if($oshaAudit->osha_q25_answer === 2 || $oshaAudit->osha_q25_answer === 3)--}}
            {{--                <div class="rounded-md bg-yellow-50 p-4">--}}
            {{--                    <div class="flex">--}}
            {{--                        <div class="flex-shrink-0">--}}
            {{--                            <svg class="h-5 w-5 text-yellow-400" viewBox="0 0 20 20" fill="currentColor"--}}
        ...
        <li class="py-10 space-y-5 page-break">
            ...
            @endif
            @if($oshaAudit->osha_q26_answer === 2 || $oshaAudit->osha_q26_answer === 3)
                <div class="rounded-md bg-yellow-50 p-4">
                    <div class="flex">
                        <div class="flex-shrink-0">
                            <svg class="h-5 w-5 text-yellow-400" viewBox="0 0 20 20" fill="currentColor"
        ...
        <li class="py-10 space-y-5 page-break">
            ...
            @endif
            @if($oshaAudit->osha_q27_answer === 2 || $oshaAudit->osha_q27_answer === 3)
                <div class="rounded-md bg-yellow-50 p-4">
                    <div class="flex">
                        <div class="flex-shrink-0">
                            <svg class="h-5 w-5 text-yellow-400" viewBox="0 0 20 20" fill="currentColor"
        ...
        <li class="py-10 space-y-5 page-break">
            ...
            @endif
            @if($oshaAudit->osha_q28_answer === 2 || $oshaAudit->osha_q28_answer === 3)
                <div class="rounded-md bg-yellow-50 p-4">
                    <div class="flex">
                        <div class="flex-shrink-0">
                            <svg class="h-5 w-5 text-yellow-400" viewBox="0 0 20 20" fill="currentColor"
        ...
        <li class="py-10 space-y-5 page-break">
            ...
            @endif
            @if($oshaAudit->osha_q29_answer === 2 || $oshaAudit->osha_q29_answer === 3)
                <div class="rounded-md bg-yellow-50 p-4">
                    <div class="flex">
                        <div class="flex-shrink-0">
                            <svg class="h-5 w-5 text-yellow-400" viewBox="0 0 20 20" fill="currentColor"
        ...
        <li class="py-10 space-y-5 page-break">
            ...
            @endif
            @if($oshaAudit->osha_q30_answer === 2 || $oshaAudit->osha_q30_answer === 3)
                <div class="rounded-md bg-yellow-50 p-4">
                    <div class="flex">
                        <div class="flex-shrink-0">
                            <svg class="h-5 w-5 text-yellow-400" viewBox="0 0 20 20" fill="currentColor"
        ...
        <li class="py-10 space-y-5 page-break">
            <div>
                <p class="font-bold">Are any doorways that are nonfunctioning or blocked marked by a sign stating “NO
                    EXIT”?</p>
                <p>
            ...
            @endif
            @if($oshaAudit->osha_q31_answer === 2 || $oshaAudit->osha_q31_answer === 3)
                <div class="rounded-md bg-yellow-50 p-4">
                    <div class="flex">
                        <div class="flex-shrink-0">
                            <svg class="h-5 w-5 text-yellow-400" viewBox="0 0 20 20" fill="currentColor"
        ...
        <li class="py-10 space-y-5 page-break">
            ...
            @endif
            @if($oshaAudit->osha_q32_answer === 2 || $oshaAudit->osha_q32_answer === 3)
                <div class="rounded-md bg-yellow-50 p-4">
                    <div class="flex">
                        <div class="flex-shrink-0">
                            <svg class="h-5 w-5 text-yellow-400" viewBox="0 0 20 20" fill="currentColor"
        ...
        <li class="py-10 space-y-5 page-break">
            ...
            @endif
            @if($oshaAudit->osha_q33_answer === 2 || $oshaAudit->osha_q33_answer === 3)
                <div class="rounded-md bg-yellow-50 p-4">
                    <div class="flex">
                        <div class="flex-shrink-0">
                            <svg class="h-5 w-5 text-yellow-400" viewBox="0 0 20 20" fill="currentColor"
        ...
        <li class="py-10 space-y-5 page-break">
            ...
            @endif
            @if($oshaAudit->osha_q34_answer === 2 || $oshaAudit->osha_q34_answer === 3)
                <div class="rounded-md bg-yellow-50 p-4">
                    <div class="flex">
                        <div class="flex-shrink-0">
                            <svg class="h-5 w-5 text-yellow-400" viewBox="0 0 20 20" fill="currentColor"
                        ...
                        <div class="ml-3">
                            ...
                            <div class="mt-2 text-sm text-yellow-700">
                                <p>29 U.S.C. § 654, 5(a)1 - Each employer shall furnish to each of his employees’
                                    ...
                                    causing or are likely to cause death or serious physical harm to his employees."</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <li class="py-10 space-y-5 page-break">
            ...
            @endif
            @if($oshaAudit->osha_q35_answer === 2 || $oshaAudit->osha_q35_answer === 3)
                <div class="rounded-md bg-yellow-50 p-4">
                    <div class="flex">
                        <div class="flex-shrink-0">
                            <svg class="h-5 w-5 text-yellow-400" viewBox="0 0 20 20" fill="currentColor"
                        ...
                        <div class="ml-3">
                            ...
                            <div class="mt-2 text-sm text-yellow-700">
                                <p>29 CFR 1910.23
                                    ...
                                    • A floor hole cover of standard strength and construction. (While the cover is not
                                    in place, the floor hole must be constantly attended by someone or must be protected
                                    by a removable standard railing.)
                                    A cover that leaves no openings more than 1 inch wide must protect every floor hole
                                    into which persons cannot accidentally walk (because fixed machinery, equipment or
                                    walls). The cover must be securely held in place to prevent tools or materials from
                                    falling through.
                                </p>
                            </div>
                        </div>
        ...
        <li class="py-10 space-y-5 page-break">
            ...
            @endif
            @if($oshaAudit->osha_q36_answer === 2 || $oshaAudit->osha_q36_answer === 3)
                <div class="rounded-md bg-yellow-50 p-4">
                    <div class="flex">
                        <div class="flex-shrink-0">
                            <svg class="h-5 w-5 text-yellow-400" viewBox="0 0 20 20" fill="currentColor"
        ...
        <li class="py-10 space-y-5 page-break">
            <div>
                <p class="font-bold">Are hoists maintained within mfg. specs, and inspected and serviced AND documented
                    under the mfg. suggested frequency?</p>
                <p>
            ...
            @endif
            @if($oshaAudit->osha_q37_answer === 2 || $oshaAudit->osha_q37_answer === 3)
                <div class="rounded-md bg-yellow-50 p-4">
                    <div class="flex">
                        <div class="flex-shrink-0">
                            <svg class="h-5 w-5 text-yellow-400" viewBox="0 0 20 20" fill="currentColor"
        ...
        <li class="py-10 space-y-5 page-break">
            <div>
                <p class="font-bold">Are used batteries stored on a leak proof container?</p>
                <p>
            ...
            @endif
            @if($oshaAudit->osha_q38_answer === 2 || $oshaAudit->osha_q38_answer === 3)
                <div class="rounded-md bg-yellow-50 p-4">
                    <div class="flex">
                        <div class="flex-shrink-0">
                            <svg class="h-5 w-5 text-yellow-400" viewBox="0 0 20 20" fill="currentColor"
        ...
        <li class="py-10 space-y-5 page-break">
            <div>
                <p class="font-bold">Are any batteries stored outside?</p>
                <p>
            ...
            @endif
            @if($oshaAudit->osha_q39_answer === 2 || $oshaAudit->osha_q39_answer === 3)
                <div class="rounded-md bg-yellow-50 p-4">
                    <div class="flex">
                        <div class="flex-shrink-0">
                            <svg class="h-5 w-5 text-yellow-400" viewBox="0 0 20 20" fill="currentColor"
                        ...
                        <div class="ml-3">
                            ...
                            <div class="mt-2 text-sm text-yellow-700">
                                <p>Batteries stored outside should be stored on impermeable surfaces and should have
                                    secondary containment. Also, it is recommended that batteries be covered to prevent
                                    acid run off.</p>
                            </div>
                        </div>
                    </div>
        ...
        <li class="py-10 space-y-5 page-break">
            <div>
                <p class="font-bold">Do automatic sprinkler heads have an 18” clearance?</p>
                <p>
            ...
            @endif
            @if($oshaAudit->osha_q40_answer === 2 || $oshaAudit->osha_q40_answer === 3)
                <div class="rounded-md bg-yellow-50 p-4">
                    <div class="flex">
                        <div class="flex-shrink-0">
                            <svg class="h-5 w-5 text-yellow-400" viewBox="0 0 20 20" fill="currentColor"
        ...
        <li class="py-10 space-y-5 page-break">
            ...
            @endif
            @if($oshaAudit->osha_q41_answer === 2 || $oshaAudit->osha_q41_answer === 3)
                <div class="rounded-md bg-yellow-50 p-4">
                    <div class="flex">
                        <div class="flex-shrink-0">
                            <svg class="h-5 w-5 text-yellow-400" viewBox="0 0 20 20" fill="currentColor"
                        ...
                        <div class="ml-3">
                            ...
                            <div class="mt-2 text-sm text-yellow-700">
                                <p>29 CFR 1926.152(a)(1)
                                    Only approved containers and portable tanks shall be used for storage and handling
                                    of flammable and combustible liquids
                                    DOT 29CFR1926.155 (1)
                                    an approved, closed container, of not more than 5 gallons capacity, having a flash
                                    arresting screen, spring closing lid and spout cover and so designed that it will
        ...
        <li class="py-10 space-y-5 page-break">
            ...
            @endif
            @if($oshaAudit->osha_q42_answer === 2 || $oshaAudit->osha_q42_answer === 3)
                <div class="rounded-md bg-yellow-50 p-4">
                    <div class="flex">
                        <div class="flex-shrink-0">
                            <svg class="h-5 w-5 text-yellow-400" viewBox="0 0 20 20" fill="currentColor"
        ...
        <li class="py-10 space-y-5 page-break">
            <div>
                <p class="font-bold">Are all gas cylinders stored properly tied down?</p>
                <p>
            ...
            @endif
            @if($oshaAudit->osha_q43_answer === 2 || $oshaAudit->osha_q43_answer === 3)
                <div class="rounded-md bg-yellow-50 p-4">
                    <div class="flex">
                        <div class="flex-shrink-0">
                            <svg class="h-5 w-5 text-yellow-400" viewBox="0 0 20 20" fill="currentColor"
        ...
        <li class="py-10 space-y-5 page-break">
            <div>
                <p class="font-bold">29 CFR 1910.101
                    29 CFR 1910.6 reference
                    49 CFR parts 171-179 & 14 CFR part 103
                    CGAP C-6-1968 & C-8-1962
                </p>
            ...
            @endif
            @if($oshaAudit->osha_q44_answer === 2 || $oshaAudit->osha_q44_answer === 3)
                <div class="rounded-md bg-yellow-50 p-4">
                    <div class="flex">
                        <div class="flex-shrink-0">
                            <svg class="h-5 w-5 text-yellow-400" viewBox="0 0 20 20" fill="currentColor"
        ...
        <li class="py-10 space-y-5 page-break">
            ...
            @endif
            @if($oshaAudit->osha_q45_answer === 2 || $oshaAudit->osha_q45_answer === 3)
                <div class="rounded-md bg-yellow-50 p-4">
                    <div class="flex">
                        <div class="flex-shrink-0">
                            <svg class="h-5 w-5 text-yellow-400" viewBox="0 0 20 20" fill="currentColor"
        ...
        <li class="py-10 space-y-5 page-break">
            ...
            @endif
            @if($oshaAudit->osha_q46_answer === 2 || $oshaAudit->osha_q46_answer === 3)
                <div class="rounded-md bg-yellow-50 p-4">
                    <div class="flex">
                        <div class="flex-shrink-0">
                            <svg class="h-5 w-5 text-yellow-400" viewBox="0 0 20 20" fill="currentColor"
                        ...
                        <div class="ml-3">
                            <h3 class="text-sm font-medium text-yellow-800">Attention needed</h3>
                            <div class="mt-2 text-sm text-yellow-700">
                                <p>29 CFR 1910.215(a)(4) - Work rests. (Bottom Plate) On offhand grinding machines, Work
                                    rests shall be kept adjusted closely to the wheel with a maximum opening of
                                    one-eighth inch
                                    29 CFR 1910.215(b)(9) - Exposure adjustment. (Top Cover over Wheel) Safety guards.
        ...
        <li class="py-10 space-y-5 page-break">
            ...
            @endif
            @if($oshaAudit->osha_q47_answer === 2 || $oshaAudit->osha_q47_answer === 3)
                <div class="rounded-md bg-yellow-50 p-4">
                    <div class="flex">
                        <div class="flex-shrink-0">
                            <svg class="h-5 w-5 text-yellow-400" viewBox="0 0 20 20" fill="currentColor"
                        ...
                        <div class="ml-3">
                            ...
                            <div class="mt-2 text-sm text-yellow-700">
                                <p>29 CFR 1910.106
                                    "No Smoking" signs shall be conspicuously posted where hazard from flammable liquid
        ...
        <li class="py-10 space-y-5 page-break">
            ...
            @endif
            @if($oshaAudit->osha_q48_answer === 2 || $oshaAudit->osha_q48_answer === 3)
                <div class="rounded-md bg-yellow-50 p-4">
                    <div class="flex">
                        <div class="flex-shrink-0">
                            <svg class="h-5 w-5 text-yellow-400" viewBox="0 0 20 20" fill="currentColor"
                        ...
                        <div class="ml-3">
                            ...
                            <div class="mt-2 text-sm text-yellow-700">
                                <p>NFPA 99(12), Sec. 11.5.3.2.1
                                    NO SMOKING signs (and/or the international symbol for no smoking), readable from a
                                    distance of 5 ft, need to be posted wherever supplemental oxygen is in use and in
        ...
        <li class="py-10 space-y-5 page-break">
            ...
            @endif
            @if($oshaAudit->osha_q49_answer === 2 || $oshaAudit->osha_q49_answer === 3)
                <div class="rounded-md bg-yellow-50 p-4">
                    <div class="flex">
                        <div class="flex-shrink-0">
                            <svg class="h-5 w-5 text-yellow-400" viewBox="0 0 20 20" fill="currentColor"
        ...
        <li class="py-10 space-y-5 page-break">
            ...
            @endif
            @if($oshaAudit->osha_q50_answer === 2 || $oshaAudit->osha_q50_answer === 3)
                <div class="rounded-md bg-yellow-50 p-4">
                    <div class="flex">
                        <div class="flex-shrink-0">
                            <svg class="h-5 w-5 text-yellow-400" viewBox="0 0 20 20" fill="currentColor"
                        ...
                        <div class="ml-3">
                            ...
                            <div class="mt-2 text-sm text-yellow-700">
                                <p>29 CFR 1910.106
                                    NFPA 30.4.5.3.4
                                    Static Electricity.
                                    All equipment such as tanks, machinery, and piping shall be designed and operated to
                                    prevent electrostatic ignitions. All metallic equipment where an ignitable mixture
                                    could be present shall be bonded or grounded. The bond or ground or both shall be
                                    physically applied or shall be inherently present by the nature of the installation.
                                    Any electrically isolated section of metallic piping or equipment shall be bonded or
                                    grounded to prevent hazardous accumulation of static electricity. All nonmetallic
        ...
        <li class="py-10 space-y-5 page-break">
            ...
            @endif
            @if($oshaAudit->osha_q51_answer === 2 || $oshaAudit->osha_q51_answer === 3)
                <div class="rounded-md bg-yellow-50 p-4">
                    <div class="flex">
                        <div class="flex-shrink-0">
                            <svg class="h-5 w-5 text-yellow-400" viewBox="0 0 20 20" fill="currentColor"
        ...
        <li class="py-10 space-y-5 page-break">
            ...
            @endif
            @if($oshaAudit->osha_q52_answer === 2 || $oshaAudit->osha_q52_answer === 3)
                <div class="rounded-md bg-yellow-50 p-4">
                    <div class="flex">
                        <div class="flex-shrink-0">
                            <svg class="h-5 w-5 text-yellow-400" viewBox="0 0 20 20" fill="currentColor"
        ...
        <li class="py-10 space-y-5 page-break">
            ...
            @endif
            @if($oshaAudit->osha_q53_answer === 2 || $oshaAudit->osha_q53_answer === 3)
                <div class="rounded-md bg-yellow-50 p-4">
                    <div class="flex">
                        <div class="flex-shrink-0">
                            <svg class="h-5 w-5 text-yellow-400" viewBox="0 0 20 20" fill="currentColor"
        ...
        <li class="py-10 space-y-5 page-break">
            <div>
                <p class="font-bold">Are any electrical cords frayed, cracked, taped, or spliced or ground missing on 3
                    prong plugs?</p>
                <p>
            ...
            @endif
            @if($oshaAudit->osha_q54_answer === 2 || $oshaAudit->osha_q54_answer === 3)
                <div class="rounded-md bg-yellow-50 p-4">
                    <div class="flex">
                        <div class="flex-shrink-0">
                            <svg class="h-5 w-5 text-yellow-400" viewBox="0 0 20 20" fill="currentColor"
                        ...
                        <div class="ml-3">
                            ...
                            <div class="mt-2 text-sm text-yellow-700">
                                <p>29 CFR 1910.334
                                    Electrical cords shall be visually inspected before use on any shift for external
                                    defects (such as loose parts, deformed and missing pins, or damage to outer jacket
        ...
        <li class="py-10 space-y-5 page-break">
            ...
            @endif
            @if($oshaAudit->osha_q55_answer === 2 || $oshaAudit->osha_q55_answer === 3)
                <div class="rounded-md bg-yellow-50 p-4">
                    <div class="flex">
                        <div class="flex-shrink-0">
                            <svg class="h-5 w-5 text-yellow-400" viewBox="0 0 20 20" fill="currentColor"
                        ...
                        <div class="ml-3">
                            ...
                            <div class="mt-2 text-sm text-yellow-700">
                                <p>EPA 530-R-09-001
                                    ...
                                    Containers should be stable (i.e., they don’t tip over easily), and they should be
                                    ...
                                    that the additional weight doesn’t break the lamps. Do not tape or rubber band lamps
                                    together.
                                </p>
                            </div>
                        </div>
        ...
        <li class="py-10 space-y-5 page-break">
            <div>
                <p class="font-bold">Miscellaneous Electrical issues?</p>
                <p>
                    @if($oshaAudit->osha_q56_answer === 1)
                        Yes
                    @elseif($oshaAudit->osha_q56_answer === 2)
                        No
                    @else
                        N/A
                    @endif
            ...
            @endif
            @if($oshaAudit->osha_q56_answer === 2 || $oshaAudit->osha_q56_answer === 3)
                <div class="rounded-md bg-yellow-50 p-4">
                    <div class="flex">
                        <div class="flex-shrink-0">
                            <svg class="h-5 w-5 text-yellow-400" viewBox="0 0 20 20" fill="currentColor"
        ...
        <li class="py-10 space-y-5 page-break">
            ...
            @endif
            @if($oshaAudit->osha_q57_answer === 2 || $oshaAudit->osha_q57_answer === 3)
                <div class="rounded-md bg-yellow-50 p-4">
                    <div class="flex">
                        <div class="flex-shrink-0">
                            <svg class="h-5 w-5 text-yellow-400" viewBox="0 0 20 20" fill="currentColor"
        ...
        <li class="py-10 space-y-5 page-break">
            <div>
                <p class="font-bold">Hybrid - Safety Gloves:
                    “Class O Heavy-Duty gloves” rated to withstand 1,000 volts.
                </p>
                <p>
            ...
            @endif
            @if($oshaAudit->osha_q58_answer === 2 || $oshaAudit->osha_q58_answer === 3)
                <div class="rounded-md bg-yellow-50 p-4">
                    <div class="flex">
                        <div class="flex-shrink-0">
                            <svg class="h-5 w-5 text-yellow-400" viewBox="0 0 20 20" fill="currentColor"
        ...
        <li class="py-10 space-y-5 page-break">
            <div>
                <p class="font-bold">Hybrid - Are the gloves in good condition? Are there any cracks visible?</p>
                <p>
            ...
            @endif
            @if($oshaAudit->osha_q59_answer === 2 || $oshaAudit->osha_q59_answer === 3)
                <div class="rounded-md bg-yellow-50 p-4">
                    <div class="flex">
                        <div class="flex-shrink-0">
                            <svg class="h-5 w-5 text-yellow-400" viewBox="0 0 20 20" fill="currentColor"
        ...
        <li class="py-10 space-y-5 page-break">
            <div>
                <p class="font-bold">Hybrid - Safety Glasses
                    Are safety glasses worn when working on hybrid vehicle?
                </p>
                <p>
            ...
            @endif
            @if($oshaAudit->osha_q60_answer === 2 || $oshaAudit->osha_q60_answer === 3)
                <div class="rounded-md bg-yellow-50 p-4">
                    <div class="flex">
                        <div class="flex-shrink-0">
                            <svg class="h-5 w-5 text-yellow-400" viewBox="0 0 20 20" fill="currentColor"
        ...
        <li class="py-10 space-y-5 page-break">
            <div>
                <p class="font-bold">Is the first aid kit identified and is it stocked with appropriate supplies? i.e.,
                    ...
                    gloves, sterile pads, triangular bandages. Recommend that the first aid kits be mounted and visible
                    for all personnel to see.</p>
                <p>
            ...
            @endif
            @if($oshaAudit->osha_q61_answer === 2 || $oshaAudit->osha_q61_answer === 3)
                <div class="rounded-md bg-yellow-50 p-4">
                    <div class="flex">
                        <div class="flex-shrink-0">
                            <svg class="h-5 w-5 text-yellow-400" viewBox="0 0 20 20" fill="currentColor"
                        ...
                        <div class="ml-3">
                            ...
                            <div class="mt-2 text-sm text-yellow-700">
                                <p>29 CFR 1910.151
                                    ...
                                    American National Standard (ANSI) Z308.1-1998. Appendix A "Minimum Requirements for
        ...
        <li class="py-10 space-y-5 page-break">
            ...
            @endif
            {{--            @if($oshaAudit->osha_q62_answer === 2 || $oshaAudit->osha_q62_answer === 3)--}}
            {{--                <div class="rounded-md bg-yellow-50 p-4">--}}
            {{--                    <div class="flex">--}}
            {{--                        <div class="flex-shrink-0">--}}
            {{--                            <svg class="h-5 w-5 text-yellow-400" viewBox="0 0 20 20" fill="currentColor"--}}
        ...
        <li class="py-10 space-y-5 page-break">
            ...
            @endif
            {{--            @if($oshaAudit->osha_q63_answer === 2 || $oshaAudit->osha_q63_answer === 3)--}}
            {{--                <div class="rounded-md bg-yellow-50 p-4">--}}
            {{--                    <div class="flex">--}}
            {{--                        <div class="flex-shrink-0">--}}
            {{--                            <svg class="h-5 w-5 text-yellow-400" viewBox="0 0 20 20" fill="currentColor"--}}
        ...
        <li class="py-10 space-y-5 page-break">
            ...
            @endif
            {{--            @if($oshaAudit->osha_q64_answer === 2 || $oshaAudit->osha_q64_answer === 3)--}}
            {{--                <div class="rounded-md bg-yellow-50 p-4">--}}
            {{--                    <div class="flex">--}}
            {{--                        <div class="flex-shrink-0">--}}
            {{--                            <svg class="h-5 w-5 text-yellow-400" viewBox="0 0 20 20" fill="currentColor"--}}
        ...
        <li class="py-10 space-y-5 page-break">
            <div>
                <p class="font-bold">Fluorescent Tubes not being properly stored</p>
                <p>
            ...
            @endif
            @if($oshaAudit->osha_q65_answer === 2 || $oshaAudit->osha_q65_answer === 3)
                <div class="rounded-md bg-yellow-50 p-4">
                    <div class="flex">
                        <div class="flex-shrink-0">
                            <svg class="h-5 w-5 text-yellow-400" viewBox="0 0 20 20" fill="currentColor"
                        ...
                        <div class="ml-3">
                            <h3 class="text-sm font-medium text-yellow-800">Attention needed</h3>
                            <div class="mt-2 text-sm text-yellow-700">
                                <p>Title 40, Chapter I, Subchapter I, Part 273
        ...
        <li class="py-10 space-y-5 page-break">
            <div>
                ...
                <p>
                    @if($oshaAudit->osha_q66_answer === 1)
                        Yes
                    @elseif($oshaAudit->osha_q66_answer === 2)
                        No
                    @else
                        N/A
                    @endif
            ...
            @endif
            @if($oshaAudit->osha_q66_answer === 2 || $oshaAudit->osha_q66_answer === 3)
                <div class="rounded-md bg-yellow-50 p-4">
                    <div class="flex">
                        <div class="flex-shrink-0">
                            <svg class="h-5 w-5 text-yellow-400" viewBox="0 0 20 20" fill="currentColor"
                        ...
                        <div class="ml-3">
                            <h3 class="text-sm font-medium text-yellow-800">Attention needed</h3>
                            <div class="mt-2 text-sm text-yellow-700">
                                <p>OSHA and the NEC both mandate a minimum clearance of 36 inches on panels of less than
                                    600 volts and less than 65,000 symmetrical fault amps.</p>
                            </div>
                        </div>
                    </div>
                </div>
            @endif
            @if($oshaAudit->osha_q66_comment)
                <div>
                    <p class="font-bold">Comments:</p>
                    <p>{{ $oshaAudit->osha_q66_comment }}</p>
                </div>
            @endif
            <div class="grid grid-cols-2 gap-10">
                @foreach($oshaAudit->getMedia('osha_q66_images') as $image)
                    <img src="{{ $image->getUrl() }}" alt="">
                @endforeach
            </div>
        </li>
        ...
        <li class="py-10 space-y-5 page-break">
            <div>
                <p class="font-bold">Electrical beakers labeling:</p>
                <p>
                    @if($oshaAudit->osha_q67_answer === 1)
                        Yes
                    @elseif($oshaAudit->osha_q67_answer === 2)
                        No
                    @else
                        N/A
                    @endif
            ...
            @endif
            @if($oshaAudit->osha_q67_answer === 2 || $oshaAudit->osha_q67_answer === 3)
                <div class="rounded-md bg-yellow-50 p-4">
                    <div class="flex">
                        <div class="flex-shrink-0">
                            <svg class="h-5 w-5 text-yellow-400" viewBox="0 0 20 20" fill="currentColor"
                        ...
                        <div class="ml-3">
                            <h3 class="text-sm font-medium text-yellow-800">Attention needed</h3>
                            <div class="mt-2 text-sm text-yellow-700">
                                <p>NFPA 70E requires all circuits be labeled properly </p>
                            </div>
                        </div>
                    </div>
                </div>
            @endif
            @if($oshaAudit->osha_q67_comment)
                <div>
                    <p class="font-bold">Comments:</p>
                    <p>{{ $oshaAudit->osha_q67_comment }}</p>
                </div>
            @endif
            <div class="grid grid-cols-2 gap-10">
                @foreach($oshaAudit->getMedia('osha_q67_images') as $image)
                    <img src="{{ $image->getUrl() }}" alt="">
                @endforeach
            </div>
        </li>
        ...
        <li class="py-10 space-y-5 page-break">
            <div>
                <p class="font-bold">Miscellaneous Electrical issues:</p>
                <p>
                    @if($oshaAudit->osha_q68_answer === 1)
                        Yes
                    @elseif($oshaAudit->osha_q68_answer === 2)
                        No
                    @else
                        N/A
                    @endif
            ...
            @endif
            @if($oshaAudit->osha_q68_answer === 2 || $oshaAudit->osha_q68_answer === 3)
                <div class="rounded-md bg-yellow-50 p-4">
                    <div class="flex">
                        <div class="flex-shrink-0">
                            <svg class="h-5 w-5 text-yellow-400" viewBox="0 0 20 20" fill="currentColor"
                        ...
                        <div class="ml-3">
                            <h3 class="text-sm font-medium text-yellow-800">Attention needed</h3>
                            <div class="mt-2 text-sm text-yellow-700">
                                <p>NFPA 70®, National Electrical Code</p>
                            </div>
                        </div>
                    </div>
                </div>
            @endif
            @if($oshaAudit->osha_q68_comment)
                <div>
                    <p class="font-bold">Comments:</p>
                    <p>{{ $oshaAudit->osha_q68_comment }}</p>
                </div>
            @endif
            <div class="grid grid-cols-2 gap-10">
                @foreach($oshaAudit->getMedia('osha_q68_images') as $image)
                    <img src="{{ $image->getUrl() }}" alt="">
                @endforeach
            </div>
        </li>
        ...
        <li class="py-10 space-y-5 page-break">
            <div>
                <p class="font-bold">Floor slippery conditions</p>
                <p>
                    @if($oshaAudit->osha_q68_answer === 1)
                        Yes
                    @elseif($oshaAudit->osha_q68_answer === 2)
