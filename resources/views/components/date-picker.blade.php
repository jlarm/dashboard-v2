...
<div wire:ignore data-datepicker="{{ $inputId }}" data-format="{{ $format }}" data-min-date="{{ $minDate }}" data-max-date="{{ $maxDate }}" data-value="{{ $value }}">
    ...
    <div class="relative">
        ...
        <div
            id="{{ $calendarId }}"
            class="hidden absolute z-50 mt-2 bg-white rounded-lg shadow-lg border border-gray-200 p-4"
        ...
        >
            ...
            <div class="grid grid-cols-7 gap-0.5 mb-2">
                <div class="text-xs font-medium text-center text-gray-500 py-2">Su</div>
                <div class="text-xs font-medium text-center text-gray-500 py-2">Mo</div>
                <div class="text-xs font-medium text-center text-gray-500 py-2">Tu</div>
                <div class="text-xs font-medium text-center text-gray-500 py-2">We</div>
                <div class="text-xs font-medium text-center text-gray-500 py-2">Th</div>
                <div class="text-xs font-medium text-center text-gray-500 py-2">Fr</div>
                <div class="text-xs font-medium text-center text-gray-500 py-2">Sa</div>
            </div>
            ...
            <div class="mt-4 pt-3 border-t border-gray-200 flex justify-between items-center">
                <button
                    type="button"
                    data-action="today"
                    class="text-sm text-arm-blue-600 hover:text-arm-blue-700 font-medium"
                >
                    Today
                </button>
