...
@else
    ...
    >
        ...
        @if ($multiple)
            <span data-checkbox class="flex-shrink-0 flex items-center justify-center size-4 rounded border border-zinc-300 dark:border-zinc-600 transition-colors">
        ...
        @else
            <span data-check class="flex-shrink-0 opacity-0 transition-opacity duration-75">
                <svg class="size-4 text-zinc-800 dark:text-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                    <path fill-rule="evenodd" d="M16.704 4.153a.75.75 0 0 1 .143 1.052l-8 10.5a.75.75 0 0 1-1.127.075l-4.5-4.5a.75.75 0 0 1 1.06-1.06l3.894 3.893 7.48-9.817a.75.75 0 0 1 1.05-.143Z" clip-rule="evenodd" />
                </svg>
            </span>
        @endif
