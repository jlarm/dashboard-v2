...
<div
    ...
    aria-live="assertive"
    class="fixed inset-0 flex items-end px-4 py-6 sm:items-start z-50 sm:p-6 pointer-events-none"
            ...
            <div class="p-4">
                <div class="flex items-start">
                    ...
                    <div class="ml-4 flex flex-shrink-0">
                        <button type="button" @click="show = false" class="inline-flex rounded-md bg-white text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-arm-blue-500 focus:ring-offset-2">
